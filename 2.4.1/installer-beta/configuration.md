...
storage class does not exist, configurator will attempt to create it using the
...
If Searchguard is enabled Configurator does the following in the provided order:
  ...
  3. If neither of them are present Configurator autogenerates searchguard certificates and uses them to setup es cluster.
...
is configured as `nodeport`, this is the NodePort requested by configurator
...
configurator otherwise consider [`sysdig.proxy.noProxy`](#sysdigproxynoproxy)
instead.<br>
**Options**:<br>
...
**Required**: `false`<br>
**Description**: Determines if configurator should generate self-signed
...
**Required**: `false`<br>
**Description**: This determines if configurator should generate self-signed<br>
