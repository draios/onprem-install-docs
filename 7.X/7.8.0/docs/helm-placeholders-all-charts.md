...
![Version: 5.1.0-260506200333-main-v923696a](https://img.shields.io/badge/Version-5.1.0--260506200333--main--v923696a-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| global.platformAuditTrail.ingestionEndpoint | string | `"sysdigcloud-platform-audit-grpc:5055"` |  |
| global.platformAuditTrail.metadataHeaders | string | `""` |  |
...
![Version: 1.0.0-260507100430-main-v4451c0f](https://img.shields.io/badge/Version-1.0.0--260507100430--main--v4451c0f-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| Key | Type | Default | Description |
|-----|------|---------|-------------|
| admissioncontroller.audit.enabled | bool | `true` |  |
...
![Version: 0.99.0-main.2026-05-08T16-26-00Z.vded7e0a](https://img.shields.io/badge/Version-0.99.0--main.2026--05--08T16--26--00Z.vded7e0a-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| alertManager.nats.enabled | bool | `true` |  |
...
![Version: 1.1.0-260416151316-main-v5375c3f](https://img.shields.io/badge/Version-1.1.0--260416151316--main--v5375c3f-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| analytics.janitor.schedule | string | `"0 8 * * *"` |  |
...
![Version: 4.1.0-260505223413-main-vf4ed018](https://img.shields.io/badge/Version-4.1.0--260505223413--main--vf4ed018-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| global.captures.remoteStorage.enabled | bool | `false` |  |
...
![Version: 1.0.20260508-v5afcce0](https://img.shields.io/badge/Version-1.0.20260508--v5afcce0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| oci://us-docker.pkg.dev/sysdig-artifact-registry-dev/gar-charts | linkerd-partials | 0.0.5 |
| oci://us-docker.pkg.dev/sysdig-artifact-registry-dev/gar-charts | sysdig-template | 1.15.0 |
...
![Version: 0.0.1](https://img.shields.io/badge/Version-0.0.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 4.1.11](https://img.shields.io/badge/AppVersion-4.1.11-informational?style=flat-square)
...
| cassandra.cassandraExporterVersion | string | `"v1.0.23-ubi"` |  |
| cassandra.cassandraImage | string | `"cassandra"` |  |
| cassandra.cassandraVersion | string | `"4.1.11-0.3.0"` |  |
...
| cassandra.createIssuer | string | `nil` | create a cassandra certificate issuer (boolean). Overrides global.certManager.createIssuer |
...
| cassandra.multiCluster.isOpenshift | bool | `false` |  |
| cassandra.multiCluster.lbAnnotations | list | `[]` |  |
| cassandra.multiCluster.overlayNetworkInitImage | string | `"network-multitool"` |  |
| cassandra.multiCluster.overlayNetworkInitImageVersion | string | `"0.0.2"` |  |
...
| cassandra.multiCluster.sidecarProxyImage | string | `"nginx"` |  |
| cassandra.multiCluster.sidecarProxyImageVersion | string | `"6.12.36"` |  |
...
| cassandra.registryName | string | `"quay.io"` | default registry name |
| cassandra.repositoryPrefix | string | `"sysdig"` | default repository prefix |
...
| cassandra.tolerations | list | `[]` | List of tolerations for cassandra pods |
...
| global.cassandra.useCertManager | string | `nil` | Whether to use cert-manager for generating certs. Set to `true` or `false` to override; `null` inherits from `global.certManager.enabled`. |
| global.cassandra.user | string | `"sysdigcassandra"` |  |
| global.cassandra.workloadName | string | `"cassandra"` | Statefulset name |
| global.certManager | object | `{"createIssuer":false,"enabled":false}` | cert-manager global config |
| global.certManager.createIssuer | bool | `false` | Create a self-signed issuer for cert-manager |
| global.certManager.enabled | bool | `false` | Enable cert-manager for generating certs |
| global.cloudProvider.isMultiAZ | bool | `false` | "true" spreads pods across AZs |
| global.datastoreStorageOverrides.cassandra.size | string | `""` | Override the Cassandra persistent volume size |
| global.datastoreStorageOverrides.cassandra.storageClass | string | `""` | Override the storage class used for Cassandra persistent volumes |
...
![Version: 5.2.0-260505223028-main-v55d79ca](https://img.shields.io/badge/Version-5.2.0--260505223028--main--v55d79ca-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 1.5.1](https://img.shields.io/badge/Version-1.5.1-informational?style=flat-square) ![AppVersion: 26.2.5.45](https://img.shields.io/badge/AppVersion-26.2.5.45-informational?style=flat-square)
...
| clickhouseKeeper.clickhouseKeeperVersion | string | `"1.2.15"` |  |
...
| clickhouseKeeper.tls.caCertificateName | string | `"clickhouse-ca-certificate"` |  |
| clickhouseKeeper.tls.caSecretName | string | `"clickhouse-ca-tls"` |  |
| clickhouseKeeper.tls.certsMountPath | string | `"/etc/clickhouse-keeper/certs"` |  |
| clickhouseKeeper.tls.issuerName | string | `"clickhouse-issuer"` |  |
| clickhouseKeeper.tls.selfSignedIssuerName | string | `"clickhouse-selfsigned-issuer"` |  |
...
![Version: 1.5.12](https://img.shields.io/badge/Version-1.5.12-informational?style=flat-square) ![AppVersion: 26.2.5.45](https://img.shields.io/badge/AppVersion-26.2.5.45-informational?style=flat-square)
...
| clickhouseShards.clickhouseBackupFIPSVersion | string | `"1.0.29-fips"` |  |
| clickhouseShards.clickhouseBackupIBMVersion | string | `"1.0.30-ibm"` |  |
| clickhouseShards.clickhouseBackupImage | string | `"clickhouse-backup"` |  |
| clickhouseShards.clickhouseBackupVersion | string | `"1.0.28"` |  |
...
| clickhouseShards.clickhouseVersion | string | `"1.2.15"` |  |
...
| clickhouseShards.config.userProfiles.admin.minInsertBlockSizeBytes | int | `1342177280` |  |
| clickhouseShards.config.userProfiles.admin.minInsertBlockSizeRows | int | `0` |  |
...
| clickhouseShards.postStartHook.command | string | `"clickhouse-client --user=$CLICKHOUSE_ADMIN_USER --password=$CLICKHOUSE_ADMIN_PASSWORD --port=$CLICKHOUSE_PORT $CLICKHOUSE_SECURE_FLAG --query=\"\n  SELECT 'DROP TABLE IF EXISTS system.' || name || ' SETTINGS max_table_size_to_drop=0;'\n  FROM system.tables\n  WHERE database = 'system'\n    AND engine = 'MergeTree'\n    AND name REGEXP '.*_log_[0-9]+$'\n\" | clickhouse-client --user=$CLICKHOUSE_ADMIN_USER --password=$CLICKHOUSE_ADMIN_PASSWORD --port=$CLICKHOUSE_PORT $CLICKHOUSE_SECURE_FLAG --multiquery || echo \"postStartHook: some rotated tables could not be dropped, skipping\"\n"` |  |
...
| clickhouseShards.storage.s3Export.enabled | bool | `false` |  |
| clickhouseShards.storage.s3Export.iamRoleArn | string | `""` |  |
...
| clickhouseShards.tls.client.loadDefaultCAFile | bool | `true` |  |
| clickhouseShards.tls.issuerName | string | `"clickhouse-issuer"` |  |
...
![Version: 5.0.0-260508174723-main-v3ae4a4f](https://img.shields.io/badge/Version-5.0.0--260508174723--main--v3ae4a4f-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| cloudsec.api.startupProbe.failureThreshold | int | `30` |  |
| cloudsec.api.startupProbe.initialDelaySeconds | int | `60` |  |
| cloudsec.api.startupProbe.periodSeconds | int | `10` |  |
| cloudsec.api.startupProbe.timeoutSeconds | int | `5` |  |
| cloudsec.audit.enabled | bool | `true` |  |
| cloudsec.cloudauth.grpc.maxReceiveMessageSize | string | `"83886080"` |  |
...
| cloudsec.collector.subscriptionCache.fetchTimeout | string | `"5m"` |  |
| cloudsec.collector.subscriptionCache.reloadBackoffTimeout | string | `"5s"` |  |
| cloudsec.collector.subscriptionCache.reloadRetries | string | `"3"` |  |
...
| cloudsec.worker.startupProbe.failureThreshold | int | `30` |  |
| cloudsec.worker.startupProbe.initialDelaySeconds | int | `60` |  |
| cloudsec.worker.startupProbe.periodSeconds | int | `10` |  |
| cloudsec.worker.startupProbe.timeoutSeconds | int | `5` |  |
...
![Version: 1.1.20260507-v3cc364f](https://img.shields.io/badge/Version-1.1.20260507--v3cc364f-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| collector.claimCheck.defaultForAllCustomers | bool | `false` |  |
| collector.claimCheck.enabled | bool | `false` |  |
| collector.claimCheck.objectStorage.bucketName | string | `""` |  |
| collector.claimCheck.objectStorage.region | string | `""` |  |
...
| collector.serviceAccount | object | `{"annotations":{},"useDedicatedServiceAccount":false}` | dedicated ServiceAccount for collector (e.g. for IRSA / GCP Workload Identity) |
| collector.serviceAccount.annotations | object | `{}` | annotations to apply to the ServiceAccount (e.g. eks.amazonaws.com/role-arn, iam.gke.io/gcp-service-account) |
| collector.serviceAccount.useDedicatedServiceAccount | bool | `false` | create a sysdigcloud-collector ServiceAccount instead of using the shared sysdig SA |
...
| collector.supportedCustomMetricsLimits[3] | string | `"50k"` |  |
| collector.supportedCustomMetricsLimits[4] | string | `"100k"` |  |
| collector.supportedCustomMetricsLimits[5] | string | `"200k"` |  |
| collector.supportedCustomMetricsLimits[6] | string | `"300k"` |  |
| collector.supportedCustomMetricsLimits[7] | string | `"400k"` |  |
| collector.supportedCustomMetricsLimits[8] | string | `"500k"` |  |
| global.admin.password | string | `"test"` |  |
| global.admin.username | string | `"test@sysdig.com"` |  |
| global.api.serviceTokens.policies.serviceToken | string | `nil` |  |
| global.apps | string | `"monitor"` |  |
...
| global.nginxVersion | string | `"6.12.43"` |  |
| global.prometheus.enabled | bool | `true` |  |
| global.secure.sysqlApi.enabled | bool | `true` |  |
...
![Version: 5.0.0-260507105644-main-vf2da962](https://img.shields.io/badge/Version-5.0.0--260507105644--main--vf2da962-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| elasticsearchExporter.imageTag | string | `"v1.3.36-ubi"` | es exporter image tag |
...
![Version: 0.9.6](https://img.shields.io/badge/Version-0.9.6-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.19.2](https://img.shields.io/badge/AppVersion-2.19.2-informational?style=flat-square)
...
| elasticsearch.jobs.ttlSecondsAfterFinished | int | `10800` | seconds after which a finished job (Completed or Failed) is automatically deleted; set to 0 for immediate cleanup, or omit this field entirely to disable TTL |
...
| elasticsearch.opensearchVersion | string | `"0.7.0"` | opensearch image tag |
...
![Version: 5.2.1-260508153722-main-v7eae67c](https://img.shields.io/badge/Version-5.2.1--260508153722--main--v7eae67c-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 5.1.0-260506200546-main-v081d922](https://img.shields.io/badge/Version-5.1.0--260506200546--main--v081d922-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 4.0.1-260506180158-main-vd2f2d73](https://img.shields.io/badge/Version-4.0.1--260506180158--main--vd2f2d73-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| falcovalidator.pprof.enabled | bool | `false` |  |
...
![Version: 5.2.0-260506175444-main-v9b3aef8](https://img.shields.io/badge/Version-5.2.0--260506175444--main--v9b3aef8-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 1.9.17](https://img.shields.io/badge/Version-1.9.17-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.0.0](https://img.shields.io/badge/AppVersion-1.0.0-informational?style=flat-square)
...
| haproxyIngress.haproxyVersion | string | `"1.8.17-v0.15-ubi"` |  |
...
| haproxyIngress.rsyslogVersion | string | `"7.6.0.260128215618"` |  |
| haproxyIngress.watchAllNamespaces | bool | `false` |  |

# helm-renderer

![Version: 1.2.360](https://img.shields.io/badge/Version-1.2.360-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 3.6.20](https://img.shields.io/badge/Version-3.6.20-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 7.9.6](https://img.shields.io/badge/AppVersion-7.9.6-informational?style=flat-square)
...
| global.cloudProvider.isMultiAZ | bool | `false` | "true" spreads pods across AZs |
| global.cloudProvider.name | string | `""` |  |
| global.datastoreStorageOverrides | object | `{}` | optional global storage overrides; takes highest precedence |
...
| kafka.version | string | `"1.6.15"` | kafka image tag |
...
| meerkatCollector.claimCheck.bucketName | string | `""` |  |
| meerkatCollector.claimCheck.enabled | bool | `false` |  |
...
![Version: 0.2.0-260506180034-main-v249d6d6](https://img.shields.io/badge/Version-0.2.0--260506180034--main--v249d6d6-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| metadataEnricher.vm.sparkDedupTtl | string | `"20m"` |  |
...
![Version: 2.2.0-260410095234-main-ve496487](https://img.shields.io/badge/Version-2.2.0--260410095234--main--ve496487-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| global.apps | string | `"monitor"` |  |
| global.clusterDomain | string | `"cluster.local"` |  |
| global.fipsCompliant | bool | `false` |  |
...
| metadataService.mdsOperatorVersion | string | `"1.5.107-v434b788"` |  |
...
![Version: 0.1.70](https://img.shields.io/badge/Version-0.1.70-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.11.4](https://img.shields.io/badge/AppVersion-2.11.4-informational?style=flat-square)

A Helm chart for Nats, the Sysdig way

**Homepage:** <https://github.com/draios/infra-datastore-nats-js>
...
* <https://github.com/draios/infra-datastore-nats-js>
...
| neo4j.neo4j.registryName | string | `"us-docker.pkg.dev/sysdig-artifact-registry-dev/gar-docker"` | default registry name |
| neo4j.neo4j.repositoryPrefix | string | `"infra"` | default repository prefix |
| neo4j.neo4j.resources.cpu | string | `"2"` |  |
| neo4j.neo4j.resources.memory | string | `"15Gi"` |  |
| neo4j.neo4jServerVersion | string | `"2026.03.1-0.5.0"` |  |
| neo4j.nodeSelector | object | `{}` |  |
| neo4j.pdbGroups.enabled | bool | `false` |  |
| neo4j.pdbGroups.groups | list | `[]` |  |
...
| neo4j.registryName | string | `"us-docker.pkg.dev/sysdig-artifact-registry-dev/gar-docker"` | default registry name |
| neo4j.repositoryPrefix | string | `"infra"` | default repository prefix |
...
| neo4jExport.backoffLimit | int | `1` |  |
| neo4jExport.batchSize | int | `10000` |  |
| neo4jExport.chunkSize | int | `10000` |  |
| neo4jExport.customerId | string | `""` |  |
| neo4jExport.customerIdOverride | int | `1` |  |
| neo4jExport.enabled | bool | `false` |  |
| neo4jExport.excludeLabels | string | `""` |  |
| neo4jExport.extraEnv | list | `[]` |  |
| neo4jExport.failedJobsHistoryLimit | int | `3` |  |
| neo4jExport.imagePullPolicy | string | `"IfNotPresent"` |  |
| neo4jExport.includeLabels | string | `""` |  |
| neo4jExport.maxJobs | int | `8` |  |
| neo4jExport.neo4j.database | string | `"neo4j"` |  |
| neo4jExport.neo4j.passwordSecretKey | string | `"neo4j-password"` |  |
| neo4jExport.neo4j.passwordSecretName | string | `""` |  |
| neo4jExport.neo4j.username | string | `"neo4j"` |  |
| neo4jExport.nodeSelector | object | `{}` |  |
| neo4jExport.podAnnotations | object | `{}` |  |
| neo4jExport.resources.limits.cpu | string | `"2"` |  |
| neo4jExport.resources.limits.memory | string | `"8Gi"` |  |
| neo4jExport.resources.requests.cpu | string | `"500m"` |  |
| neo4jExport.resources.requests.memory | string | `"2Gi"` |  |
| neo4jExport.s3.bucket | string | `""` |  |
| neo4jExport.s3.endpoint | string | `""` |  |
| neo4jExport.s3.prefix | string | `"neo4j-export"` |  |
| neo4jExport.s3.region | string | `"us-east-1"` |  |
| neo4jExport.schedule | string | `"0 2 * * *"` |  |
| neo4jExport.securityContext.allowPrivilegeEscalation | bool | `false` |  |
| neo4jExport.securityContext.capabilities.drop[0] | string | `"ALL"` |  |
| neo4jExport.securityContext.readOnlyRootFilesystem | bool | `false` |  |
| neo4jExport.securityContext.runAsGroup | int | `1000` |  |
| neo4jExport.securityContext.runAsNonRoot | bool | `true` |  |
| neo4jExport.securityContext.runAsUser | int | `1000` |  |
| neo4jExport.storageClassName | string | `"sysdig-reclaim-delete"` |  |
| neo4jExport.successfulJobsHistoryLimit | int | `3` |  |
| neo4jExport.suspend | bool | `false` |  |
| neo4jExport.workspaceSize | string | `"100Gi"` |  |
...
![Version: 5.0.1-260505223305-main-v2c1df6e](https://img.shields.io/badge/Version-5.0.1--260505223305--main--v2c1df6e-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 5.0.0-260507152253-main-vccddca1](https://img.shields.io/badge/Version-5.0.0--260507152253--main--vccddca1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 0.0.1-260508075639-main-vd4cfd06](https://img.shields.io/badge/Version-0.0.1--260508075639--main--vd4cfd06-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.0.1-260508075639-main-vd4cfd06](https://img.shields.io/badge/AppVersion-0.0.1--260508075639--main--vd4cfd06-informational?style=flat-square)
...
| global.nats.certManager.enabled | bool | `false` |  |
| global.platformAuditTrail.enabled | bool | `false` |  |
| platformAuditService.authorizationService.enabled | bool | `false` |  |
| platformAuditService.authorizationService.endpoint | string | `"sysdig-authorization-service:9602"` |  |
| platformAuditService.batching.ingestion.flushPeriod | string | `"5s"` |  |
| platformAuditService.batching.ingestion.flushingRoutines | int | `1` |  |
| platformAuditService.batching.ingestion.maxAsyncCalls | int | `30` |  |
| platformAuditService.batching.ingestion.maxBatchByteSize | int | `10000` |  |
| platformAuditService.batching.ingestion.maxBatchSize | int | `10` |  |
| platformAuditService.batching.ingestion.maxBufferByteSize | int | `50000` |  |
| platformAuditService.batching.ingestion.maxBufferSize | int | `50` |  |
| platformAuditService.customerSettingsCacheTTL | string | `"10m"` |  |
| platformAuditService.debugLogEnabled | bool | `false` |  |
| platformAuditService.enabled | bool | `true` |  |
| platformAuditService.ingestion.nats.streams | object | `{}` |  |
| platformAuditService.natsjs.tls.enabled | string | `"true"` |  |
| platformAuditService.platformAuditReplicaCount | int | `3` |  |
| platformAuditService.registryName | string | `"us-docker.pkg.dev/sysdig-artifact-registry-dev/gar-docker"` |  |
| platformAuditService.repositoryPrefix | string | `"monitor"` |  |
| platformAuditService.resources.platformAuditService.limits.cpu | int | `1` |  |
| platformAuditService.resources.platformAuditService.limits.memory | string | `"250Mi"` |  |
| platformAuditService.resources.platformAuditService.requests.cpu | string | `"250m"` |  |
| platformAuditService.resources.platformAuditService.requests.memory | string | `"50Mi"` |  |
| platformAuditService.sdauthCacheTTL | string | `"5m"` |  |
| platformAuditService.serviceAccountName | string | `"sysdig"` |  |
...
![Version: 0.0.1-260324170723-main-v10e584a](https://img.shields.io/badge/Version-0.0.1--260324170723--main--v10e584a-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.0.1-260324170723-main-v10e584a](https://img.shields.io/badge/AppVersion-0.0.1--260324170723--main--v10e584a-informational?style=flat-square)
...
| platformService.alerts.nats.js.retryOnFailedConnect | bool | `true` |  |
...
| platformService.platformZones.ingress[0].hosts[0].paths[1].apiGatewayRouteName | string | `"sysdigcloud-platform-zones-v2-public-api"` |  |
| platformService.platformZones.ingress[0].hosts[0].paths[1].apiGatewayStickySessions | bool | `true` |  |
| platformService.platformZones.ingress[0].hosts[0].paths[1].openshiftRouteName | string | `"sysdigcloud-platform-zones-v2-public-api"` |  |
| platformService.platformZones.ingress[0].hosts[0].paths[1].path | string | `"/platform/v2/zones"` |  |
...
| platformService.platformZones.ingress[0].hosts[0].paths[2].apiGatewayRouteName | string | `"sysdigcloud-platform-zones-private-api"` |  |
| platformService.platformZones.ingress[0].hosts[0].paths[2].apiGatewayStickySessions | bool | `true` |  |
| platformService.platformZones.ingress[0].hosts[0].paths[2].openshiftRouteName | string | `"sysdigcloud-platform-zones-private-api"` |  |
| platformService.platformZones.ingress[0].hosts[0].paths[2].path | string | `"/api/v1/zones"` |  |
...
| platformService.platformZones.ingress[0].hosts[0].paths[3].apiGatewayRouteName | string | `"sysdigcloud-platform-zones-v2-private-api"` |  |
| platformService.platformZones.ingress[0].hosts[0].paths[3].apiGatewayStickySessions | bool | `true` |  |
| platformService.platformZones.ingress[0].hosts[0].paths[3].openshiftRouteName | string | `"sysdigcloud-platform-zones-v2-private-api"` |  |
| platformService.platformZones.ingress[0].hosts[0].paths[3].path | string | `"/api/v2/zones"` |  |
| platformService.platformZones.ingress[0].hosts[0].paths[3].pathType | string | `"ImplementationSpecific"` |  |
| platformService.platformZones.ingress[0].hosts[0].paths[3].serviceName | string | `"sysdigcloud-platform-zones-service-rest"` |  |
| platformService.platformZones.ingress[0].hosts[0].paths[3].servicePort | int | `8090` |  |
...
![Version: 0.0.1-main.2026-05-08T08-22-53Z.b24a397](https://img.shields.io/badge/Version-0.0.1--main.2026--05--08T08--22--53Z.b24a397-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 4.3.3-260508194441-main-v8c318b2](https://img.shields.io/badge/Version-4.3.3--260508194441--main--v8c318b2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| policies.api.startupProbe.failureThreshold | int | `30` |  |
| policies.api.startupProbe.initialDelaySeconds | int | `30` |  |
| policies.api.startupProbe.periodSeconds | int | `10` |  |
| policies.api.startupProbe.timeoutSeconds | int | `5` |  |
...
![Version: 0.5.25](https://img.shields.io/badge/Version-0.5.25-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.16.0](https://img.shields.io/badge/AppVersion-1.16.0-informational?style=flat-square)
...
## pg_largeobject Vacuum Maintenance

A CronJob (`pg-vacuum-cronjob`) runs every 12 hours to proactively prevent `pg_largeobject` bloat,
which can cause WAL growth and disk exhaustion.

### How it works

Every 12 hours the job runs across all non-template databases and:

1. Runs `vacuumlo -n` to check for orphaned large objects (blobs no longer referenced by any application table).
2. If no orphans are found the database is skipped — no lock is acquired.
3. If orphans are found it proceeds with:
   - `vacuumlo` — deletes the orphaned large objects
   - `VACUUM FULL ANALYZE pg_largeobject` — reclaims disk space from dead tuples
   - `VACUUM FULL ANALYZE pg_largeobject_metadata` — same for the companion catalog table

### Why not pg_repack?

`pg_repack` cannot operate on system catalog tables such as `pg_largeobject`. `VACUUM FULL` is the only viable reclaim mechanism.

### Warning

`VACUUM FULL` acquires an `ACCESS EXCLUSIVE` lock on `pg_largeobject` for the duration of the run.
During this window no large object reads or writes are possible for that database.
The job is scheduled during low-traffic hours (`0 */12 * * *`) to minimise impact.

### Configuration

| Key | Default | Description |
|-----|---------|-------------|
| `postgresql.vacuum.enabled` | `true` | Enable the vacuum CronJob |
| `postgresql.vacuum.schedule` | `"0 */12 * * *"` | Cron schedule for the job |
| `postgresql.vacuum.imagePullSecret` | `"sysdigcloud-pull-secret"` | Image pull secret for the job pod |
...
| global.cloudProvider.isMultiAZ | bool | `false` |  |
| global.datastoreStorageOverrides.postgresqlha.size | string | `""` | Override the postgres-ha persistent volume size |
| global.datastoreStorageOverrides.postgresqlha.storageClass | string | `""` | Override the storage class used for postgres-ha persistent volumes |
| global.deployment | string | `"kubernetes"` |  |
| global.helmDeploy | bool | `false` |  |
| global.namespace | string | `"sysdig"` |  |
| global.postgresImageName | string | `"postgres-15"` |  |
| global.postgresVersion | string | `"0.1.25"` |  |
...
| postgresql.backups.version | string | `"0.4.6"` |  |
...
| postgresql.ha.exporterVersion | string | `"v0.11.29-ubi"` |  |
| postgresql.ha.operatorVersion | string | `"0.4.5"` |  |
| postgresql.ha.pgMajorVersion | int | `15` |  |
| postgresql.ha.spiloVersion | string | `"0.3.7"` |  |
...
| postgresql.vacuum.enabled | bool | `true` |  |
| postgresql.vacuum.imagePullSecret | string | `"sysdigcloud-pull-secret"` |  |
| postgresql.vacuum.schedule | string | `"0 */6 * * *"` |  |
...
| postgresql.pgsqlBackups.version | string | `"0.4.6"` |  |
| postgresql.pvStorageSize.medium.postgresql | string | `"60Gi"` |  |
| postgresql.reEncryptPasswords | bool | `false` |  |
| postgresql.resources.postgresql.limits.cpu | int | `4` |  |
| postgresql.resources.postgresql.limits.memory | string | `"4Gi"` |  |
...
![Version: 1.2.1-260505222849-main-v4c7a6f3](https://img.shields.io/badge/Version-1.2.1--260505222849--main--v4c7a6f3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 1.19.0-main.2026-04-22T13-20-00Z.a4c1c0a](https://img.shields.io/badge/Version-1.19.0--main.2026--04--22T13--20--00Z.a4c1c0a-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 3.3.1-main.2026-05-04T13-33-21Z.v8f09f30](https://img.shields.io/badge/Version-3.3.1--main.2026--05--04T13--33--21Z.v8f09f30-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 5.3.0-260508155808-main-vb81f050](https://img.shields.io/badge/Version-5.3.0--260508155808--main--vb81f050-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 2.1.48](https://img.shields.io/badge/Version-2.1.48-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.16.5](https://img.shields.io/badge/AppVersion-1.16.5-informational?style=flat-square)
...
| global.legacyRedis.redisTls.extraMasterConfig | string | `""` | Extra config appended to master.conf |
| global.legacyRedis.redisTls.extraRedisConfig | string | `""` | Extra config appended to redis.conf. Each extraXConfig field accepts a multiline string of raw Redis directives, one per line. Example:   extraRedisConfig: |     hz 15     maxmemory-policy allkeys-lru |
| global.legacyRedis.redisTls.extraReplicaConfig | string | `""` | Extra config appended to replica.conf |
| global.legacyRedis.redisTls.extraSentinelConfig | string | `""` | Extra config appended to sentinel.conf |
...
| global.legacyRedis.redisTls.probes | object | `{"redis":{"liveness":{"failureThreshold":5,"initialDelaySeconds":180},"readiness":{"failureThreshold":5,"initialDelaySeconds":50}},"sentinel":{"liveness":{"failureThreshold":5,"initialDelaySeconds":180},"readiness":{"failureThreshold":5,"initialDelaySeconds":50}}}` | redisTls probe configuration. Override initialDelaySeconds/failureThreshold for slow storage environments. |
| global.legacyRedis.redisTls.probes.redis.liveness.failureThreshold | int | `5` | Consecutive failures before container restart |
| global.legacyRedis.redisTls.probes.redis.liveness.initialDelaySeconds | int | `180` | Seconds before first liveness probe fires |
| global.legacyRedis.redisTls.probes.redis.readiness.failureThreshold | int | `5` | Consecutive failures before pod is marked not-ready |
| global.legacyRedis.redisTls.probes.redis.readiness.initialDelaySeconds | int | `50` | Seconds before first readiness probe fires |
| global.legacyRedis.redisTls.probes.sentinel.liveness.failureThreshold | int | `5` | Consecutive failures before container restart |
| global.legacyRedis.redisTls.probes.sentinel.liveness.initialDelaySeconds | int | `180` | Seconds before first liveness probe fires |
| global.legacyRedis.redisTls.probes.sentinel.readiness.failureThreshold | int | `5` | Consecutive failures before pod is marked not-ready |
| global.legacyRedis.redisTls.probes.sentinel.readiness.initialDelaySeconds | int | `50` | Seconds before first readiness probe fires |
...
| global.legacyRedis.redisTls.sentinel.version | string | `"0.0.11"` | redisTls sentinel docker image tag |
...
| global.legacyRedis.redisTls.version | string | `"0.0.12"` | redisTls docker image tag |
...
![Version: 5.2.1-260511091917-main-ve4bd690](https://img.shields.io/badge/Version-5.2.1--260511091917--main--ve4bd690-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| Key | Type | Default | Description |
|-----|------|---------|-------------|
| global.api.serviceTokens.remoteStorage.serviceToken | string | `""` |  |
| global.apps | string | `"secure"` |  |
| global.cloudProvider.fedramp | bool | `false` |  |
| global.cloudProvider.name | string | `""` |  |
| global.cloudProvider.region | string | `""` |  |
| global.dnsName | string | `""` |  |
| global.gke.sqlproxy.enabled | bool | `false` |  |
| global.ingressNetworking | string | `"hostnetwork"` |  |
| global.installationType | string | `"local"` |  |
| global.legacyPostgres.postgresDatabases.remoteStorage.admindb | string | `"root_db"` |  |
| global.legacyPostgres.postgresDatabases.remoteStorage.adminpassword | string | `nil` |  |
| global.legacyPostgres.postgresDatabases.remoteStorage.adminusername | string | `"root_user"` |  |
| global.legacyPostgres.postgresDatabases.remoteStorage.db | string | `"sysdig_db"` |  |
| global.legacyPostgres.postgresDatabases.remoteStorage.host | string | `"sysdigcloud-postgresql"` |  |
| global.legacyPostgres.postgresDatabases.remoteStorage.idletxtimeout | string | `"60min"` |  |
| global.legacyPostgres.postgresDatabases.remoteStorage.password | string | `nil` |  |
| global.legacyPostgres.postgresDatabases.remoteStorage.port | int | `5432` |  |
| global.legacyPostgres.postgresDatabases.remoteStorage.sslmode | string | `"disable"` |  |
| global.legacyPostgres.postgresDatabases.remoteStorage.username | string | `"sysdig_user"` |  |
| global.namespace | string | `"sysdig"` |  |
| global.platformAuditTrail.enabled | bool | `false` |  |
| global.platformAuditTrail.ingestionEndpoint | string | `"sysdigcloud-platform-audit-grpc:5055"` |  |
| global.platformAuditTrail.metadataHeaders | string | `""` |  |
...
| global.secure.iamUser.accessKey | string | `""` |  |
| global.secure.iamUser.secretKey | string | `""` |  |
| global.secure.iamUserGov.accessKey | string | `""` |  |
| global.secure.iamUserGov.secretKey | string | `""` |  |
| global.secure.trustedIdentity.aws | string | `""` |  |
| global.secure.trustedIdentity.awsGov | string | `""` |  |
| remoteStorage.affinity | object | `{}` |  |
| remoteStorage.api.replicaCount | int | `1` |  |
| remoteStorage.api.serviceAccountName | string | `"sysdig"` |  |
| remoteStorage.audit.enabled | bool | `true` |  |
| remoteStorage.authorizationService.enabled | bool | `false` |  |
| remoteStorage.authorizationService.endpoint | string | `"sysdig-authorization-service:9602"` |  |
| remoteStorage.awsProbeRegion | string | `"us-east-1"` |  |
| remoteStorage.enabled | bool | `false` |  |
| remoteStorage.forceMigrations | bool | `false` |  |
| remoteStorage.ingress[0].hosts[0].paths[0].apiGatewayRouteName | string | `"sysdigcloud-remote-storage-v1-http"` |  |
| remoteStorage.ingress[0].hosts[0].paths[0].openshiftRouteName | string | `"sysdigcloud-remote-storage-v1-http"` |  |
| remoteStorage.ingress[0].hosts[0].paths[0].path | string | `"/api/remote-storage/v1"` |  |
| remoteStorage.ingress[0].hosts[0].paths[0].serviceName | string | `"sysdigcloud-remote-storage-http"` |  |
| remoteStorage.ingress[0].hosts[0].paths[0].servicePort | int | `7000` |  |
| remoteStorage.ingress[0].labels."app.kubernetes.io/managed-by" | string | `"ingress-config"` |  |
| remoteStorage.ingress[0].labels."app.kubernetes.io/name" | string | `"ingress-config"` |  |
| remoteStorage.ingress[0].labels."app.kubernetes.io/part-of" | string | `"sysdigcloud"` |  |
| remoteStorage.ingress[0].labels.role | string | `"ingress-config"` |  |
| remoteStorage.ingress[0].labels.tier | string | `"infra"` |  |
| remoteStorage.ingress[0].name | string | `"sysdigcloud-remote-storage-ingress"` |  |
| remoteStorage.janitor.enabled | bool | `true` |  |
| remoteStorage.janitor.resources.limits.cpu | int | `1` |  |
| remoteStorage.janitor.resources.limits.memory | string | `"500Mi"` |  |
| remoteStorage.janitor.resources.requests.cpu | string | `"250m"` |  |
| remoteStorage.janitor.resources.requests.memory | string | `"50Mi"` |  |
| remoteStorage.janitor.retentionDays | int | `7` |  |
| remoteStorage.janitor.schedule | string | `"00 9 * * *"` |  |
| remoteStorage.janitor.suspend | bool | `false` |  |
| remoteStorage.monitorBucketMigrator.db.dbname | string | `""` |  |
| remoteStorage.monitorBucketMigrator.db.host | string | `""` |  |
| remoteStorage.monitorBucketMigrator.db.password | string | `""` |  |
| remoteStorage.monitorBucketMigrator.db.port | int | `5432` |  |
| remoteStorage.monitorBucketMigrator.db.sslmode | string | `"require"` |  |
| remoteStorage.monitorBucketMigrator.db.user | string | `""` |  |
| remoteStorage.monitorBucketMigrator.dryRun | bool | `true` |  |
| remoteStorage.monitorBucketMigrator.enabled | bool | `false` |  |
| remoteStorage.monitorBucketMigrator.resources.limits.cpu | string | `"500m"` |  |
| remoteStorage.monitorBucketMigrator.resources.limits.memory | string | `"256Mi"` |  |
| remoteStorage.monitorBucketMigrator.resources.requests.cpu | string | `"100m"` |  |
| remoteStorage.monitorBucketMigrator.resources.requests.memory | string | `"64Mi"` |  |
| remoteStorage.nodeSelector | object | `{}` |  |
| remoteStorage.objectStorage.jwt.secret | string | `""` |  |
| remoteStorage.presignExpiry | string | `"15m"` |  |
| remoteStorage.proxy.enable | bool | `false` |  |
| remoteStorage.registryName | string | `"us-docker.pkg.dev/sysdig-artifact-registry-dev/gar-docker"` |  |
| remoteStorage.repositoryPrefix | string | `"secure"` |  |
| remoteStorage.resources.postgresqlinit.limits.cpu | string | `"500m"` |  |
| remoteStorage.resources.postgresqlinit.limits.memory | string | `"500Mi"` |  |
| remoteStorage.resources.postgresqlinit.requests.cpu | string | `"100m"` |  |
| remoteStorage.resources.postgresqlinit.requests.memory | string | `"100Mi"` |  |
| remoteStorage.resources.postgresqlinitLinkerd.limits.cpu | string | `"500m"` |  |
| remoteStorage.resources.postgresqlinitLinkerd.limits.memory | string | `"500Mi"` |  |
| remoteStorage.resources.postgresqlinitLinkerd.requests.cpu | string | `"100m"` |  |
| remoteStorage.resources.postgresqlinitLinkerd.requests.memory | string | `"100Mi"` |  |
| remoteStorage.resources.remoteStorageAPI.limits.cpu | int | `1` |  |
| remoteStorage.resources.remoteStorageAPI.limits.memory | string | `"500Mi"` |  |
| remoteStorage.resources.remoteStorageAPI.requests.cpu | string | `"250m"` |  |
| remoteStorage.resources.remoteStorageAPI.requests.memory | string | `"50Mi"` |  |
| remoteStorage.scaler.api.cpuThreshold | int | `90` |  |
| remoteStorage.scaler.api.enabled | bool | `true` |  |
| remoteStorage.scaler.api.maxReplicaCount | int | `5` |  |
| remoteStorage.scaler.api.memoryThreshold | int | `90` |  |
| remoteStorage.sdauthCacheTTL | string | `"5m"` |  |
| remoteStorage.statsPrintedLabels | string | `""` |  |
| remoteStorage.tolerations | list | `[]` |  |
...
![Version: 0.1.0-260506175735-main-v1065163](https://img.shields.io/badge/Version-0.1.0--260506175735--main--v1065163-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| responseActions.audit.enabled | bool | `true` |  |
...
![Version: 2.0.0-260508112110-main-v492036d](https://img.shields.io/badge/Version-2.0.0--260508112110--main--v492036d-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 2.0.0-260428075800-main-v042a13a](https://img.shields.io/badge/Version-2.0.0--260428075800--main--v042a13a-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| scanningv2AgentsConf.startupProbe.failureThreshold | int | `6` |  |
| scanningv2AgentsConf.startupProbe.initialDelaySeconds | int | `10` |  |
| scanningv2AgentsConf.startupProbe.periodSeconds | int | `10` |  |
| scanningv2AgentsConf.startupProbe.timeoutSeconds | int | `5` |  |
...
![Version: 2.0.0-260507111025-main-vd41b3ed](https://img.shields.io/badge/Version-2.0.0--260507111025--main--vd41b3ed-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 2.0.0-260427182708-main-vaaf4dc7](https://img.shields.io/badge/Version-2.0.0--260427182708--main--vaaf4dc7-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| scanningv2Credentialstore.replicaCount | int | `2` |  |
...
| scanningv2Credentialstore.resources.scanningv2Credentialstore.limits.cpu | int | `4` |  |
| scanningv2Credentialstore.resources.scanningv2Credentialstore.limits.memory | string | `"1Gi"` |  |
| scanningv2Credentialstore.resources.scanningv2Credentialstore.requests.cpu | int | `2` |  |
...
| scanningv2Credentialstore.scaler.enabled | bool | `true` |  |
...
![Version: 2.0.0-260507101545-main-vcf3f249](https://img.shields.io/badge/Version-2.0.0--260507101545--main--vcf3f249-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| global.scanningv2.enabled | bool | `true` |  |
| global.secretsManagement.generate | bool | `true` |  |
| global.zones.enabled | bool | `true` |  |
...
| scanningv2Notifier.clickhouse.enabled | bool | `true` |  |
...
| scanningv2Notifier.clickhouse.query.maxPageSize | int | `100` |  |
...
| scanningv2Notifier.resources.scanningv2Notifier.limits.memory | string | `"2Gi"` |  |
| scanningv2Notifier.resources.scanningv2Notifier.requests.cpu | int | `2` |  |
| scanningv2Notifier.resources.scanningv2Notifier.requests.memory | string | `"2Gi"` |  |
...
![Version: 2.0.1-260427182649-main-v7084527](https://img.shields.io/badge/Version-2.0.1--260427182649--main--v7084527-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| scanningv2Pkgmeta.scaler.enabled | bool | `true` |  |
...
![Version: 2.0.0-260506085258-main-vc669d57](https://img.shields.io/badge/Version-2.0.0--260506085258--main--vc669d57-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| global.scanningv2.enabled | bool | `true` |  |
| global.secretsManagement.generate | bool | `true` |  |
| scanningv2Policies.audit.enabled | bool | `true` |  |
...
![Version: 2.1.1-260507122705-main-v920221f](https://img.shields.io/badge/Version-2.1.1--260507122705--main--v920221f-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 2.0.0-260507110619-main-v6f2b61a](https://img.shields.io/badge/Version-2.0.0--260507110619--main--v6f2b61a-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 2.0.0-260507104708-main-vcafc47d](https://img.shields.io/badge/Version-2.0.0--260507104708--main--vcafc47d-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| global.scanningv2.enabled | bool | `true` |  |
| global.secretsManagement.generate | bool | `true` |  |
| scanningv2Riskmanager.audit.enabled | bool | `true` |  |
...
![Version: 2.0.0-260507104644-main-vb9f1808](https://img.shields.io/badge/Version-2.0.0--260507104644--main--vb9f1808-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 2.0.0-260507095516-main-vb0d5aeb](https://img.shields.io/badge/Version-2.0.0--260507095516--main--vb0d5aeb-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| scanningv2Sbom.scaler.enabled | bool | `true` |  |
...
![Version: 2.0.0-260420135445-main-v7966879](https://img.shields.io/badge/Version-2.0.0--260420135445--main--v7966879-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| scanningv2Scanengine.scaler.enabled | bool | `true` |  |
...
![Version: 2.0.0-260508171546-main-v98fce37](https://img.shields.io/badge/Version-2.0.0--260508171546--main--v98fce37-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| scanningv2Scanrequestor.replicaCount | int | `2` |  |
...
| scanningv2Scanrequestor.scaler.enabled | bool | `true` |  |
...
![Version: 2.0.0-260507101344-main-vc8c3ca4](https://img.shields.io/badge/Version-2.0.0--260507101344--main--vc8c3ca4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| scanningv2Scanresults.ingress[0].hosts[0].paths[0].apiGatewayRouteName | string | `"sysdigcloud-scanningv2-scanresults-v2"` |  |
| scanningv2Scanresults.ingress[0].hosts[0].paths[0].openshiftRouteName | string | `"sysdigcloud-scanningv2-scanresults-v2"` |  |
| scanningv2Scanresults.ingress[0].hosts[0].paths[0].path | string | `"/api/scanning/scanresults/v2"` |  |
...
| scanningv2Scanresults.ingress[0].hosts[0].paths[1].apiGatewayRouteName | string | `"sysdigcloud-scanningv2-scanresults-vuln-pipeline"` |  |
| scanningv2Scanresults.ingress[0].hosts[0].paths[1].openshiftRouteName | string | `"sysdigcloud-scanningv2-scanresults-vuln-pipeline"` |  |
| scanningv2Scanresults.ingress[0].hosts[0].paths[1].path | string | `"/secure/vulnerability/v1beta1/pipeline-results"` |  |
...
| scanningv2Scanresults.ingress[0].hosts[0].paths[2].apiGatewayRouteName | string | `"sysdigcloud-scanningv2-scanresults-vuln-results"` |  |
| scanningv2Scanresults.ingress[0].hosts[0].paths[2].openshiftRouteName | string | `"sysdigcloud-scanningv2-scanresults-vuln-results"` |  |
| scanningv2Scanresults.ingress[0].hosts[0].paths[2].path | string | `"/secure/vulnerability/v1beta1/results"` |  |
...
| scanningv2Scanresults.ingress[0].hosts[0].paths[3].apiGatewayRouteName | string | `"sysdigcloud-scanningv2-scanresults-vuln-pipeline-v1"` |  |
| scanningv2Scanresults.ingress[0].hosts[0].paths[3].openshiftRouteName | string | `"sysdigcloud-scanningv2-scanresults-vuln-pipeline-v1"` |  |
| scanningv2Scanresults.ingress[0].hosts[0].paths[3].path | string | `"/secure/vulnerability/v1/pipeline-results"` |  |
...
| scanningv2Scanresults.ingress[0].hosts[0].paths[4].apiGatewayRouteName | string | `"sysdigcloud-scanningv2-scanresults-vuln-results-v1"` |  |
| scanningv2Scanresults.ingress[0].hosts[0].paths[4].openshiftRouteName | string | `"sysdigcloud-scanningv2-scanresults-vuln-results-v1"` |  |
| scanningv2Scanresults.ingress[0].hosts[0].paths[4].path | string | `"/secure/vulnerability/v1/results"` |  |
...
![Version: 2.0.1-260424083350-main-vb07da1a](https://img.shields.io/badge/Version-2.0.1--260424083350--main--vb07da1a-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| scanningv2Vulns.scaler.enabled | bool | `true` |  |
...
![Version: 1.0.0-260428082155-main-v1e0d820](https://img.shields.io/badge/Version-1.0.0--260428082155--main--v1e0d820-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 1.23.731-260508103620-main-vaa3de77c](https://img.shields.io/badge/Version-1.23.731--260508103620--main--vaa3de77c-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| image.tag | string | `"1.23.731-260508103620-main-vaa3de77c"` |  |
...
![Version: 3.0.1-260407110538-main-v553df69](https://img.shields.io/badge/Version-3.0.1--260407110538--main--v553df69-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| secureGraphGatherer.replicaCount | int | `1` |  |
...
![Version: 3.1.0-260507203357-main-vdf6862a](https://img.shields.io/badge/Version-3.1.0--260507203357--main--vdf6862a-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| global.ingressNetworking | string | `"hostnetwork"` |  |
| global.namespace | string | `"sysdig"` |  |
| global.neo4jDatabases.graphingestion.adminpassword | string | `nil` |  |
...
| global.neo4jDatabases.graphingestion.password | string | `nil` |  |
...
| secureGraphIngestion.migrations.downMigrationLimit | int | `20` |  |
| secureGraphIngestion.migrations.enableNewMigrator | bool | `false` |  |
...
| secureGraphIngestion.networkExposure.batchTimeout | string | `"10m"` |  |
| secureGraphIngestion.networkExposure.enable | bool | `true` |  |
| secureGraphIngestion.networkExposure.flushInterval | string | `"3s"` |  |
| secureGraphIngestion.networkExposure.messageBatchSize | int | `200` |  |
...
| secureGraphIngestion.ownershipAttribution.customLabels.enabled | bool | `true` |  |
...
| secureGraphIngestion.ownershipAttribution.enableAwsResources | bool | `true` |  |
| secureGraphIngestion.ownershipAttribution.enableAzureResources | bool | `true` |  |
| secureGraphIngestion.ownershipAttribution.enableGcpResources | bool | `true` |  |
| secureGraphIngestion.ownershipAttribution.enableKubeResources | bool | `true` |  |
| secureGraphIngestion.ownershipAttribution.enableVMRuntimeImages | bool | `true` |  |
| secureGraphIngestion.postureScanCompletedStreamEnabled | bool | `false` |  |
| secureGraphIngestion.progressDeadlineSeconds | int | `1200` |  |
| secureGraphIngestion.realtime.aws.consumerName | string | `"realtime-aws-processor"` |  |
| secureGraphIngestion.realtime.aws.enabled | bool | `false` |  |
| secureGraphIngestion.realtime.aws.messageBatchSize | string | `"50"` |  |
| secureGraphIngestion.realtime.aws.streamName | string | `"graph-ingestion-realtime"` |  |
| secureGraphIngestion.realtime.aws.subject | string | `"graph.realtime.aws.>"` |  |
| secureGraphIngestion.realtime.azure.consumerName | string | `"realtime-azure-processor"` |  |
| secureGraphIngestion.realtime.azure.enabled | bool | `false` |  |
| secureGraphIngestion.realtime.azure.messageBatchSize | string | `"50"` |  |
| secureGraphIngestion.realtime.azure.streamName | string | `"graph-ingestion-realtime"` |  |
| secureGraphIngestion.realtime.azure.subject | string | `"graph.realtime.azure.>"` |  |
| secureGraphIngestion.realtime.enabled | bool | `false` |  |
| secureGraphIngestion.realtime.gcp.consumerName | string | `"realtime-gcp-processor"` |  |
| secureGraphIngestion.realtime.gcp.enabled | bool | `false` |  |
| secureGraphIngestion.realtime.gcp.messageBatchSize | string | `"50"` |  |
| secureGraphIngestion.realtime.gcp.streamName | string | `"graph-ingestion-realtime"` |  |
| secureGraphIngestion.realtime.gcp.subject | string | `"graph.realtime.gcp.>"` |  |
| secureGraphIngestion.realtime.ibm.consumerName | string | `"realtime-ibm-processor"` |  |
| secureGraphIngestion.realtime.ibm.enabled | bool | `false` |  |
| secureGraphIngestion.realtime.ibm.messageBatchSize | string | `"50"` |  |
| secureGraphIngestion.realtime.ibm.streamName | string | `"graph-ingestion-realtime"` |  |
| secureGraphIngestion.realtime.ibm.subject | string | `"graph.realtime.ibm.>"` |  |
...
| secureGraphIngestion.vm.dedicatedConsumerGroups | string | `""` |  |
| secureGraphIngestion.vm.enableMixAndBatch | bool | `false` |  |
| secureGraphIngestion.vm.enableScanEvents | bool | `true` |  |
| secureGraphIngestion.vm.enableScanEventsRelationship | bool | `true` |  |
...
| secureGraphIngestion.vm.enableWorkloadScanEvent | bool | `true` |  |
| secureGraphIngestion.vm.forwardingAsyncPublish | bool | `false` |  |
| secureGraphIngestion.vm.forwardingEnabled | bool | `false` |  |
| secureGraphIngestion.vm.forwardingPublishBatchSize | int | `20` |  |
| secureGraphIngestion.vm.lockOnDeletion | bool | `true` |  |
| secureGraphIngestion.vm.preserveVulnTimestamp | bool | `true` |  |
| secureGraphIngestion.vm.scanFindingsAllowedCustomers | string | `""` |  |
| secureGraphIngestion.vm.scanFindingsEnabled | bool | `false` |  |
| secureGraphIngestion.vm.skipUnchangedHasInstalled | bool | `true` |  |
...
| secureGraphIngestion.vm.vulnSeverityThreshold | string | `"0"` |  |
| secureGraphIngestion.vm.zoneLockingOptimization | bool | `true` |  |
...
![Version: 3.0.0-260504195556-main-v4e7902c](https://img.shields.io/badge/Version-3.0.0--260504195556--main--v4e7902c-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| secureGraphQuery.manifestMaxSizeBytes | string | `"1048576"` |  |
...
![Version: 1.23.731-260508152832-main-v234badee](https://img.shields.io/badge/Version-1.23.731--260508152832--main--v234badee-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| dbImage.tag | string | `"1.23.731-260508152832-main-v234badee"` |  |
| global.apps | string | `"secure"` |  |
...
| image.tag | string | `"1.23.731-260508152832-main-v234badee"` |  |
...
| secureIacAgenthandler.livenessProbe.enabled | bool | `true` |  |
| secureIacAgenthandler.livenessProbe.failureThreshold | int | `3` |  |
| secureIacAgenthandler.livenessProbe.initialDelaySeconds | int | `30` |  |
| secureIacAgenthandler.livenessProbe.periodSeconds | int | `15` |  |
| secureIacAgenthandler.livenessProbe.timeoutSeconds | int | `5` |  |
...
| secureIacAgenthandler.resources.secureIacAgenthandler.requests.cpu | string | `"200m"` |  |
...
| secureIacAgenthandler.secureDataKubeScanResultSkipWorkloadDeliveryForAllTenants | bool | `false` |  |
| secureIacAgenthandler.secureDataKubeScanResultSkipWorkloadDeliveryForTenants | string | `""` |  |
...
![Version: 1.23.731-260427122352-main-vae98dfdd](https://img.shields.io/badge/Version-1.23.731--260427122352--main--vae98dfdd-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| dbImage.tag | string | `"1.23.731-260427122352-main-vae98dfdd"` |  |
...
| image.tag | string | `"1.23.731-260427122352-main-vae98dfdd"` |  |
...
| secureIacClusterAnalysis.partitionManager.queryTimeout | string | `""` |  |
...
| secureIacClusterAnalysis.startupProbe.failureThreshold | int | `12` |  |
| secureIacClusterAnalysis.startupProbe.periodSeconds | int | `5` |  |
| secureIacClusterAnalysis.startupProbe.timeoutSeconds | int | `2` |  |
...
![Version: 1.23.731-260508135636-main-v6ae665a9](https://img.shields.io/badge/Version-1.23.731--260508135636--main--v6ae665a9-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| dbImage.tag | string | `"1.23.731-260508135636-main-v6ae665a9"` |  |
| global.apps | string | `"secure"` |  |
...
| global.complianceReview.taskTrackingRetentionHours | int | `1` |  |
| global.iac.audit.workers | int | `5` |  |
...
| image.tag | string | `"1.23.731-260508135636-main-v6ae665a9"` |  |
...
![Version: 1.23.731-260506052930-main-v53a36c10](https://img.shields.io/badge/Version-1.23.731--260506052930--main--v53a36c10-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| dbImage.tag | string | `"1.23.731-260506052930-main-v53a36c10"` |  |
| global.apps | string | `"secure"` |  |
| global.iac.audit.workers | int | `5` |  |
| global.iac.clusterEnvironment | string | `"aws"` |  |
...
| global.legacyPostgres.postgresDatabases.policy.idleConns | string | `""` |  |
| global.legacyPostgres.postgresDatabases.policy.maxConnLife | string | `""` |  |
| global.legacyPostgres.postgresDatabases.policy.maxConns | string | `""` |  |
...
| image.tag | string | `"1.23.731-260506052930-main-v53a36c10"` |  |
...
| secureIacPolicy.enforceGoMemLimit | bool | `false` |  |
...
| secureIacPolicy.resources.secureIacPolicy.requests.cpu | string | `"200m"` |  |
...
![Version: 1.23.731-260511102728-main-vc657faca](https://img.shields.io/badge/Version-1.23.731--260511102728--main--vc657faca-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| dbImage.tag | string | `"1.23.731-260511102728-main-vc657faca"` |  |
| global.apps | string | `"secure"` |  |
...
| image.tag | string | `"1.23.731-260511102728-main-vc657faca"` |  |
...
| secureIacScheduler.cloudauthAccountActivityMode | string | `"cloudengine"` |  |
...
| secureIacScheduler.natsjs.agentHandlerConsumer.ackWait | string | `"600s"` |  |
| secureIacScheduler.natsjs.agentHandlerConsumer.durable | string | `"secure-iac-agenthandler-consumer-durable"` |  |
| secureIacScheduler.natsjs.agentHandlerConsumer.maxInFlight | int | `1024` |  |
| secureIacScheduler.natsjs.agentHandlerConsumer.msgMaxRetries | int | `3` |  |
| secureIacScheduler.natsjs.agentHandlerConsumer.nakDeliverBackOff | string | `"10s"` |  |
| secureIacScheduler.natsjs.agentHandlerConsumer.name | string | `"secure-iac-agenthandler-consumer"` |  |
| secureIacScheduler.natsjs.agentHandlerConsumer.pullBatch | int | `10` |  |
| secureIacScheduler.natsjs.agentHandlerConsumer.streamName | string | `"secure-iac-agenthandler"` |  |
| secureIacScheduler.natsjs.agentHandlerConsumer.subject | string | `"agenthandler.>"` |  |
| secureIacScheduler.natsjs.cloudauthConsumer.ackWait | string | `"600s"` |  |
| secureIacScheduler.natsjs.cloudauthConsumer.durable | string | `"secure-iac-cloudauth-consumer-durable"` |  |
| secureIacScheduler.natsjs.cloudauthConsumer.maxInFlight | int | `1024` |  |
| secureIacScheduler.natsjs.cloudauthConsumer.msgMaxRetries | int | `3` |  |
| secureIacScheduler.natsjs.cloudauthConsumer.nakDeliverBackOff | string | `"10s"` |  |
| secureIacScheduler.natsjs.cloudauthConsumer.name | string | `"secure-iac-cloudauth-consumer"` |  |
| secureIacScheduler.natsjs.cloudauthConsumer.pullBatch | int | `10` |  |
| secureIacScheduler.natsjs.cloudauthConsumer.streamName | string | `"cloudauth-api-cloudaccount-activity-stream"` |  |
| secureIacScheduler.natsjs.cloudauthConsumer.subject | string | `"cloudauth.cloudaccount.activity"` |  |
| secureIacScheduler.natsjs.taskEventsConsumer.ackWait | string | `"600s"` |  |
| secureIacScheduler.natsjs.taskEventsConsumer.durable | string | `"secure-iac-taskevents-consumer-durable"` |  |
| secureIacScheduler.natsjs.taskEventsConsumer.maxInFlight | int | `1024` |  |
| secureIacScheduler.natsjs.taskEventsConsumer.msgMaxRetries | int | `3` |  |
| secureIacScheduler.natsjs.taskEventsConsumer.nakDeliverBackOff | string | `"10s"` |  |
| secureIacScheduler.natsjs.taskEventsConsumer.name | string | `"secure-iac-taskevents-consumer"` |  |
| secureIacScheduler.natsjs.taskEventsConsumer.pullBatch | int | `10` |  |
| secureIacScheduler.natsjs.taskEventsConsumer.streamName | string | `"secure-iac-taskevents"` |  |
| secureIacScheduler.natsjs.taskEventsConsumer.subject | string | `"task.events.>"` |  |
...
| secureIacScheduler.resources.secureIacScheduler.requests.cpu | string | `"200m"` |  |
...
![Version: 1.23.731-260506085555-main-v1d17c133](https://img.shields.io/badge/Version-1.23.731--260506085555--main--v1d17c133-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| dbImage.tag | string | `"1.23.731-260506085555-main-v1d17c133"` |  |
| global.apps | string | `"secure"` |  |
| global.iac.audit.workers | int | `5` |  |
| global.iac.graphdb.enabled | bool | `true` |  |
| global.iac.ingestion.endpoint | string | `"sysdigcloud-events-ingestion:3000"` |  |
...
| image.tag | string | `"1.23.731-260506085555-main-v1d17c133"` |  |
| secureIacWorkload.ANE.disabledTenants | string | `""` |  |
| secureIacWorkload.ANE.enable | bool | `true` |  |
...
| secureIacWorkload.resources.secureIacWorkload.requests.cpu | string | `"200m"` |  |
...
![Version: 0.1.0-260507123755-main-vdac37ba](https://img.shields.io/badge/Version-0.1.0--260507123755--main--vdac37ba-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)

Sysdig Inventory API
...
| global.apps | string | `"secure"` |  |
| global.iac.audit.workers | int | `5` |  |
| global.iac.environment | string | `""` |  |
| global.iac.metrics.annotations."prometheus.io/path" | string | `"/metrics"` |  |
| global.iac.metrics.annotations."prometheus.io/port" | string | `"25000"` |  |
| global.iac.metrics.annotations."prometheus.io/scrape" | string | `"true"` |  |
| global.iac.migrator.enabled | bool | `false` |  |
| global.iac.natsjs.endpoint | string | `"nats"` |  |
| global.iac.natsjs.insecure.enabled | bool | `false` |  |
| global.iac.natsjs.tls.enabled | bool | `true` |  |
| global.iac.serviceAccountName | string | `"sysdig"` |  |
| global.installationType | string | `"local"` |  |
| global.legacyPostgres.postgresDatabases.inventory.admindb | string | `"postgres"` |  |
| global.legacyPostgres.postgresDatabases.inventory.adminpassword | string | `nil` |  |
| global.legacyPostgres.postgresDatabases.inventory.adminusername | string | `"postgres"` |  |
...
| global.legacyPostgres.postgresDatabases.inventory.sslmode | string | `"disable"` |  |
| global.legacyPostgres.postgresDatabases.inventory.username | string | `"inventorydbuser"` |  |
| global.legacyRedis.redisClientsSecure.inventory.password | string | `nil` |  |
| global.legacyRedis.redisClientsSecure.inventory.pubCaCrt | string | `nil` |  |
| global.legacyRedis.redisClientsSecure.inventory.tls | bool | `false` |  |
| global.legacyRedis.redisHa | bool | `false` |  |
| global.legacyRedis.redisTls.endpoint | string | `"redistls"` |  |
| global.legacyRedis.redisTls.ha | bool | `false` |  |
| global.legacyRedis.redisTls.password | string | `""` |  |
...
| global.namespace | string | `"sysdig"` |  |
| global.nats.secure.enabled | bool | `false` |  |
| global.platformAuditTrail.enabled | bool | `false` |  |
| global.platformAuditTrail.ingestionEndpoint | string | `"sysdigcloud-platform-audit-grpc:5055"` |  |
| global.platformAuditTrail.metadataHeaders | string | `""` |  |
| global.posture.kspm.enabled | bool | `true` |  |
...
| secureIacInventory.audit.enabled | bool | `true` |  |
| secureIacInventory.autoscale.enabled | bool | `true` |  |
| secureIacInventory.dbImage.repository | string | `"inventory-db-migrations-postgres"` |  |
| secureIacInventory.dbImage.tag | string | `"main"` |  |
| secureIacInventory.dumpHeapProfileEnabled | bool | `false` |  |
| secureIacInventory.enabled | bool | `true` |  |
| secureIacInventory.grpcMaxMsgSizeMbs | int | `700` |  |
| secureIacInventory.image.repository | string | `"inventory"` |  |
| secureIacInventory.ingress[0].annotations."ingress.kubernetes.io/affinity" | string | `"cookie"` |  |
| secureIacInventory.ingress[0].annotations."ingress.kubernetes.io/session-cookie-name" | string | `"INGRESSCOOKIEAPI"` |  |
| secureIacInventory.ingress[0].hosts[0].paths[0].apiGatewayRouteName | string | `"secure-iac-inventory-service"` |  |
| secureIacInventory.ingress[0].hosts[0].paths[0].apiGatewayStickySessions | bool | `true` |  |
...
| secureIacInventory.readinessProbe.enabled | bool | `true` |  |
| secureIacInventory.registryName | string | `"us-docker.pkg.dev/sysdig-artifact-registry-dev/gar-docker"` |  |
| secureIacInventory.replicaCount | int | `2` |  |
| secureIacInventory.reportingCustomerIds | string | `"1"` |  |
| secureIacInventory.reportingFrequency | string | `"24h"` |  |
| secureIacInventory.reportingPageSize | string | `"1000"` |  |
| secureIacInventory.reportingPolicyIds | string | `"285044"` |  |
...
| secureIacInventory.startupProbe.successThreshold | int | `1` |  |
| secureIacInventory.startupProbe.timeoutSeconds | int | `5` |  |
| secureInventory.audit.enabled | bool | `false` |  |
| secureInventory.auth.disabled | bool | `false` |  |
| secureInventory.autoscale.enabled | bool | `true` |  |
| secureInventory.cloudengine.api.grpc.address | string | `"secure-iac-cloudengine-service:8080"` |  |
| secureInventory.enabled | bool | `true` |  |
| secureInventory.graphQuery.api.grpc.address | string | `"secure-graph-query:6000"` |  |
| secureInventory.host | string | `"0.0.0.0"` |  |
| secureInventory.image.pullSecret | string | `"sysdigcloud-pull-secret"` |  |
| secureInventory.ingress[0].hosts[0].paths[0].apiGatewayRouteName | string | `"secure-inventory"` |  |
| secureInventory.ingress[0].hosts[0].paths[0].openshiftRouteName | string | `"secure-inventory"` |  |
| secureInventory.ingress[0].hosts[0].paths[0].path | string | `"/api/inventory/v2"` |  |
| secureInventory.ingress[0].hosts[0].paths[0].serviceName | string | `"secure-inventory"` |  |
| secureInventory.ingress[0].hosts[0].paths[0].servicePort | int | `8080` |  |
| secureInventory.ingress[0].labels."app.kubernetes.io/managed-by" | string | `"ingress-config"` |  |
| secureInventory.ingress[0].labels."app.kubernetes.io/name" | string | `"ingress-config"` |  |
| secureInventory.ingress[0].labels."app.kubernetes.io/part-of" | string | `"sysdigcloud"` |  |
| secureInventory.ingress[0].labels.role | string | `"ingress-config"` |  |
| secureInventory.ingress[0].labels.tier | string | `"infra"` |  |
| secureInventory.ingress[0].name | string | `"inventory-ingress"` |  |
| secureInventory.initDb.enabled | bool | `true` |  |
| secureInventory.initDb.image.pullSecret | string | `"sysdigcloud-pull-secret"` |  |
| secureInventory.livenessProbe.enabled | bool | `true` |  |
| secureInventory.logging | string | `"info"` |  |
| secureInventory.metrics.host | string | `"0.0.0.0"` |  |
| secureInventory.metrics.port | int | `25000` |  |
| secureInventory.port | int | `8080` |  |
| secureInventory.readinessProbe.enabled | bool | `true` |  |
| secureInventory.registryName | string | `"us-docker.pkg.dev/sysdig-artifact-registry-dev/gar-docker"` |  |
| secureInventory.replicas | int | `2` |  |
| secureInventory.repositoryPrefix | string | `"secure"` |  |
| secureInventory.resources.inventory.limits.cpu | int | `2` |  |
| secureInventory.resources.inventory.limits.memory | string | `"2Gi"` |  |
| secureInventory.resources.inventory.requests.cpu | string | `"250m"` |  |
| secureInventory.resources.inventory.requests.memory | string | `"250Mi"` |  |
| secureInventory.resources.postgresqlinit.limits.cpu | string | `"200m"` |  |
| secureInventory.resources.postgresqlinit.limits.memory | string | `"256Mi"` |  |
| secureInventory.resources.postgresqlinit.requests.cpu | string | `"100m"` |  |
| secureInventory.resources.postgresqlinit.requests.memory | string | `"128Mi"` |  |
| secureInventory.securityContext.readOnlyRootFilesystem | bool | `true` |  |
| secureInventory.securityContext.runAsRoot | bool | `false` |  |
| secureInventory.serviceAccountName | string | `"sysdig"` |  |
| secureInventory.serviceName | string | `"secure-inventory"` |  |
| secureInventory.startupProbe.enabled | bool | `true` |  |
| secureInventory.startupProbe.failureThreshold | int | `3` |  |
| secureInventory.startupProbe.initialDelaySeconds | int | `5` |  |
| secureInventory.startupProbe.periodSeconds | int | `10` |  |
| secureInventory.startupProbe.successThreshold | int | `1` |  |
| secureInventory.startupProbe.timeoutSeconds | int | `5` |  |
| secureInventory.sysql.api.grpc.address | string | `"secure-sysql-api:6000"` |  |
| secureInventory.sysql.api.grpc.receiveMessageSize | int | `8388608` |  |
| secureInventory.sysql.api.rest.address | string | `"secure-sysql-api"` |  |
| secureInventory.sysql.cacheTTL | string | `"0m"` |  |
| secureInventory.sysql.countEntitiesParallelism | int | `500` |  |
| secureInventory.workload.api.grpc.address | string | `"secure-iac-workload-service:8080"` |  |
...
![Version: 0.1.0-260508080244-main-va02062f](https://img.shields.io/badge/Version-0.1.0--260508080244--main--va02062f-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 3.0.0-260505154356-main-v5da2a58](https://img.shields.io/badge/Version-3.0.0--260505154356--main--v5da2a58-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| secureResourceIngestion.fullCloudScanIngestedResourcesPublisherAllowedTenants | string | `""` |  |
| secureResourceIngestion.fullCloudScanIngestedResourcesPublisherSkipTenants | string | `""` |  |
...
| secureResourceIngestion.nats.consumer.realtime.stream.name | string | `"secure-data-resources-realtime"` |  |
| secureResourceIngestion.nats.consumer.realtime.subject | string | `"secure.data.resources.realtimeresults"` |  |
...
![Version: 0.2.0](https://img.shields.io/badge/Version-0.2.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 3.21.0](https://img.shields.io/badge/AppVersion-3.21.0-informational?style=flat-square)
...
| sysdigCertificateExporter.blackbox.version | string | `"0.0.31"` |  |
...
| sysdigCertificateExporter.version | string | `"0.0.35"` |  |
...
![Version: 0.5.11-260508080255-main-va02062f](https://img.shields.io/badge/Version-0.5.11--260508080255--main--va02062f-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| sysqlApi.sysql.customer_rate_limiter.refill_interval | string | `"100ms"` |  |
...
| sysqlApi.sysql.grpc_default_version | string | `"0.14.36"` |  |
| sysqlApi.sysql.index_mapping.analytics/v1-alpha | string | `"0.2.0+clickhouse"` |  |
| sysqlApi.sysql.index_mapping.v1 | string | `"0.14.36"` |  |
| sysqlApi.sysql.index_mapping.v2 | string | `"0.16.74"` |  |
...
| sysqlApi.sysql.instance_rate_limiter.refill_interval | string | `"100ms"` |  |
| sysqlApi.sysql.issuer_rate_limiter.burst_size | int | `100` |  |
| sysqlApi.sysql.issuer_rate_limiter.enabled | bool | `true` |  |
| sysqlApi.sysql.issuer_rate_limiter.refill_interval | string | `"100ms"` |  |
...
![Version: 5.1.1-260427090734-main-vf7a560a](https://img.shields.io/badge/Version-5.1.1--260427090734--main--vf7a560a-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| ticketing.audit.enabled | bool | `true` |  |
...
![Version: 6.0.0-260424151110-main-v865d228](https://img.shields.io/badge/Version-6.0.0--260424151110--main--v865d228-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 6.0.0-260505205257-main-v9e28bd1](https://img.shields.io/badge/Version-6.0.0--260505205257--main--v9e28bd1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| uiInspect.ingress[0].labels."app.kubernetes.io/managed-by" | string | `"Helm"` |  |
...
![Version: 6.0.0-260511091017-main-ve5f5cebe](https://img.shields.io/badge/Version-6.0.0--260511091017--main--ve5f5cebe-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| uiMonitor.ingress[0].labels."app.kubernetes.io/managed-by" | string | `"Helm"` |  |
...
| uiSecure.ingress[0].labels."app.kubernetes.io/managed-by" | string | `"Helm"` |  |
...
| zookeeper.version | string | `"1.6.15"` | zookeeper image tag |
