...
Synthetic chart containing the union of all global values across component charts. The values.yaml is generated by scripts/values_defaults/generate_globals_yaml.py — do not edit it manually.
...
| global.airgapped_repository_prefix | string | `""` |  |
| global.alertingSystem.enabled | bool | `true` |  |
| global.api.serviceTokens.activityAudit.serviceToken | string | `""` |  |
| global.api.serviceTokens.admissionController.serviceToken | string | `""` |  |
| global.api.serviceTokens.alertManager.serviceToken | string | `""` |  |
| global.api.serviceTokens.alertNotifier.serviceToken | string | `""` |  |
| global.api.serviceTokens.analytics.serviceToken | string | `""` |  |
| global.api.serviceTokens.api.serviceToken | string | `""` |  |
| global.api.serviceTokens.azureMetricsConverter.serviceToken | string | `""` |  |
| global.api.serviceTokens.billingWorker.serviceToken | string | `""` |  |
| global.api.serviceTokens.certman.serviceToken | string | `""` |  |
| global.api.serviceTokens.cloudWatch.serviceToken | string | `""` |  |
| global.api.serviceTokens.cloudauth.serviceToken | string | `""` |  |
| global.api.serviceTokens.cloudsec.serviceToken | string | `""` |  |
| global.api.serviceTokens.cloudwatchMetricConverter.serviceToken | string | `""` |  |
| global.api.serviceTokens.compliance.serviceToken | string | `""` |  |
| global.api.serviceTokens.controlPlaneShield.api.serviceToken | string | `""` |  |
| global.api.serviceTokens.copilot.serviceToken | string | `""` |  |
| global.api.serviceTokens.costDigest.serviceToken | string | `""` |  |
| global.api.serviceTokens.eventMonitor.serviceToken | string | `""` |  |
| global.api.serviceTokens.events.serviceToken | string | `""` |  |
| global.api.serviceTokens.eventsForwarder.serviceToken | string | `""` |  |
| global.api.serviceTokens.falcocloud.serviceToken | string | `""` |  |
| global.api.serviceTokens.falcovalidator.serviceToken | string | `""` |  |
| global.api.serviceTokens.findingsApi.serviceToken | string | `""` |  |
| global.api.serviceTokens.fingerprints.serviceToken | string | `""` |  |
| global.api.serviceTokens.integrations.serviceToken | string | `""` |  |
| global.api.serviceTokens.internalTools.serviceToken | string | `""` |  |
| global.api.serviceTokens.jira.serviceToken | string | `""` |  |
| global.api.serviceTokens.machineLearningProfiling.serviceToken | string | `""` |  |
| global.api.serviceTokens.meerkat.serviceToken | string | `""` |  |
| global.api.serviceTokens.meerkatAggregator.serviceToken | string | `""` |  |
| global.api.serviceTokens.meerkatApi.serviceToken | string | `""` |  |
| global.api.serviceTokens.meerkatCostAdvisor.serviceToken | string | `""` |  |
| global.api.serviceTokens.metadataEnricher.serviceToken | string | `""` |  |
| global.api.serviceTokens.metadataService.serviceToken | string | `""` |  |
| global.api.serviceTokens.metricsAggregator.serviceToken | string | `""` |  |
| global.api.serviceTokens.natsExternal.serviceToken | string | `""` |  |
| global.api.serviceTokens.netsec.serviceToken | string | `""` |  |
| global.api.serviceTokens.olapdbReporting.serviceToken | string | `""` |  |
| global.api.serviceTokens.olapdbReportingWorker.serviceToken | string | `""` |  |
| global.api.serviceTokens.onboarding.serviceToken | string | `""` |  |
| global.api.serviceTokens.overview.serviceToken | string | `""` |  |
| global.api.serviceTokens.padvisor.serviceToken | string | `""` |  |
| global.api.serviceTokens.platformAudit.serviceToken | string | `""` |  |
| global.api.serviceTokens.platformService.alerts.serviceToken | string | `""` |  |
| global.api.serviceTokens.platformService.automations.serviceToken | string | `""` |  |
| global.api.serviceTokens.platformService.hva.serviceToken | string | `""` |  |
| global.api.serviceTokens.platformService.zones.serviceToken | string | `""` |  |
| global.api.serviceTokens.plotter.serviceToken | string | `""` |  |
| global.api.serviceTokens.policies.serviceToken | string | `""` |  |
| global.api.serviceTokens.posture.serviceToken | string | `""` |  |
| global.api.serviceTokens.processTree.serviceToken | string | `""` |  |
| global.api.serviceTokens.profiling.serviceToken | string | `""` |  |
| global.api.serviceTokens.promRemoteWrite.serviceToken | string | `""` |  |
| global.api.serviceTokens.promchap.serviceToken | string | `""` |  |
| global.api.serviceTokens.rapidResponse.serviceToken | string | `""` |  |
| global.api.serviceTokens.regionSync.serviceToken | string | `""` |  |
| global.api.serviceTokens.regionSyncRead.serviceToken | string | `""` |  |
| global.api.serviceTokens.remoteStorage.serviceToken | string | `""` |  |
| global.api.serviceTokens.responseActions.serviceToken | string | `""` |  |
| global.api.serviceTokens.rulesDeployer.serviceToken | string | `""` |  |
| global.api.serviceTokens.scanning.serviceToken | string | `""` |  |
| global.api.serviceTokens.scanningv2Notifier.serviceToken | string | `""` |  |
| global.api.serviceTokens.scanningv2Pkgmeta.serviceToken | string | `""` |  |
| global.api.serviceTokens.scanningv2Policies.serviceToken | string | `""` |  |
| global.api.serviceTokens.scanningv2RegistryScanner.serviceToken | string | `""` |  |
| global.api.serviceTokens.scanningv2Reporting.serviceToken | string | `""` |  |
| global.api.serviceTokens.scanningv2Riskmanager.serviceToken | string | `""` |  |
| global.api.serviceTokens.scanningv2Scanresults.serviceToken | string | `""` |  |
| global.api.serviceTokens.secureDspm.serviceToken | string | `""` |  |
| global.api.serviceTokens.secureGraphIngestion.serviceToken | string | `""` |  |
| global.api.serviceTokens.secureGraphQuery.serviceToken | string | `""` |  |
| global.api.serviceTokens.secureIac.serviceToken | string | `""` |  |
| global.api.serviceTokens.secureIacCloudcollector.serviceToken | string | `""` |  |
| global.api.serviceTokens.secureIacPolicy.serviceToken | string | `""` |  |
| global.api.serviceTokens.secureNetworkExposureService.serviceToken | string | `""` |  |
| global.api.serviceTokens.securePostureEngineService.serviceToken | string | `""` |  |
| global.api.serviceTokens.secureResourceComposer.serviceToken | string | `""` |  |
| global.api.serviceTokens.secureResourceIngestion.serviceToken | string | `""` |  |
| global.api.serviceTokens.secureRisk.serviceToken | string | `""` |  |
| global.api.serviceTokens.sfdc.serviceToken | string | `""` |  |
| global.api.serviceTokens.som.serviceToken | string | `""` |  |
| global.api.serviceTokens.statefulDetections.serviceToken | string | `""` |  |
| global.api.serviceTokens.telecaster.serviceToken | string | `""` |  |
| global.api.serviceTokens.threats.serviceToken | string | `""` |  |
| global.api.serviceTokens.ticketing.serviceToken | string | `""` |  |
| global.api.serviceTokens.todo.serviceToken | string | `""` |  |
| global.api.serviceTokens.worker.serviceToken | string | `""` |  |
| global.apps | string | `"monitor secure"` |  |
| global.authorizationService.enabled | bool | `true` |  |
| global.azure.apps.custodian.clientId | string | `""` |  |
| global.azure.apps.custodian.clientSecret | string | `""` |  |
| global.azure.apps.custodian.tenantId | string | `""` |  |
| global.azure.apps.sysdigSecure.clientId | string | `""` |  |
| global.azure.apps.sysdigSecure.clientSecret | string | `""` |  |
...
| global.beacon.enablePromMetadata | bool | `false` |  |
...
| global.captures.remoteStorage.enabled | bool | `true` |  |
| global.cassandra.caSecretName | string | `"cassandra-ca-secret"` |  |
| global.cassandra.datacenterName | string | `"DC1"` |  |
| global.cassandra.endpoint | string | `"sysdigcloud-cassandra"` |  |
| global.cassandra.external | bool | `false` |  |
| global.cassandra.password | string | `""` |  |
| global.cassandra.port | int | `9042` |  |
| global.cassandra.protocolVersion | int | `4` |  |
| global.cassandra.replicaCount | int | `3` |  |
| global.cassandra.replicationStrategy | string | `"NetworkTopologyStrategy"` |  |
| global.cassandra.secure | bool | `true` |  |
| global.cassandra.ssl | bool | `true` |  |
| global.cassandra.sslCaCrt | string | `""` |  |
| global.cassandra.sslCaKey | string | `""` |  |
| global.cassandra.sslVerify | bool | `false` |  |
| global.cassandra.useCertManager | string | `nil` |  |
| global.cassandra.user | string | `"sysdigcassandra"` |  |
| global.cassandra.workloadName | string | `"sysdigcloud-cassandra"` |  |
| global.certManager.createIssuer | bool | `false` |  |
| global.certManager.enabled | bool | `false` |  |
| global.certificate.customCA | bool | `false` |  |
| global.certificate.customCerts | list | `[]` |  |
| global.certificate.generate | bool | `true` |  |
| global.certificate.serverCrt | string | `"change_me"` |  |
| global.certificate.serverKey | string | `"change_me"` |  |
| global.clickhouse.adminPassword | string | `""` |  |
| global.clickhouse.dataBaseConfig.caCertPath | string | `"/opt/certs/clickhouse-ca-tls/ca.crt"` |  |
| global.clickhouse.dataBaseConfig.dbName | string | `"sysdig"` |  |
| global.clickhouse.dataBaseConfig.endPoint | string | `"clickhouse-shards.sysdig.svc.cluster.local:9440"` |  |
...
| global.clickhouse.readerPassword | string | `""` |  |
...
| global.clickhouse.writerPassword | string | `""` |  |
...
| global.collector.certificate.generate | bool | `true` |  |
...
| global.credentialsEncryption.token | string | `""` |  |
| global.datastoreStorageOverrides.cassandra.size | string | `""` |  |
| global.datastoreStorageOverrides.cassandra.storageClass | string | `""` |  |
| global.datastoreStorageOverrides.nats.size | string | `""` |  |
| global.datastoreStorageOverrides.nats.storageClass | string | `""` |  |
| global.datastoreStorageOverrides.postgresql.size | string | `""` |  |
| global.datastoreStorageOverrides.postgresql.storageClass | string | `""` |  |
| global.datastoreStorageOverrides.postgresqlha.size | string | `""` |  |
| global.datastoreStorageOverrides.postgresqlha.storageClass | string | `""` |  |
| global.deployment | string | `"kubernetes"` |  |
| global.dnsName | string | `"REPLACE_ME_WITH_DNS_NAME"` |  |
| global.elasticsearch.basename | string | `"elasticsearch"` |  |
| global.elasticsearch.clientsConfigs.discovery | bool | `true` |  |
| global.elasticsearch.clientsConfigs.signAWSRequests | bool | `false` |  |
| global.elasticsearch.external | bool | `false` |  |
| global.elasticsearch.hostname | string | `"sysdigcloud-elasticsearch"` |  |
| global.elasticsearch.nodeDiscovery | bool | `true` |  |
| global.elasticsearch.nodeDiscoveryInterval | string | `"10m"` |  |
| global.elasticsearch.port | int | `9200` |  |
| global.elasticsearch.replicaCount | string | `"3"` |  |
| global.elasticsearch.scheme | string | `"https"` |  |
| global.elasticsearch.serviceAccount | string | `"sysdig"` |  |
| global.elasticsearch.tlsencryption.adminUser | string | `"sysdig"` |  |
| global.elasticsearch.tlsencryption.caCertExpiry | string | `"87660h"` |  |
| global.elasticsearch.tlsencryption.caCertRenewBefore | string | `"360h"` |  |
| global.elasticsearch.tlsencryption.caCrts | list | `[]` |  |
| global.elasticsearch.tlsencryption.caCrtsExternalSecretName | string | `""` |  |
| global.elasticsearch.tlsencryption.certificateIssuer | string | `"sysdig-selfsigned-issuer"` |  |
| global.elasticsearch.tlsencryption.certificateIssuerKind | string | `"ClusterIssuer"` |  |
| global.elasticsearch.tlsencryption.createIssuer | bool | `false` |  |
| global.elasticsearch.tlsencryption.elasticsearchCASecretName | string | `"elasticsearch-ca-secret"` |  |
| global.elasticsearch.tlsencryption.enabled | bool | `true` |  |
| global.elasticsearch.tlsencryption.privateKeyAlgorithm | string | `"RSA"` |  |
| global.elasticsearch.tlsencryption.privateKeySize | int | `4096` |  |
| global.elasticsearch.tlsencryption.trtUser | string | `"sysdig_trt"` |  |
| global.elasticsearch.tlsencryption.useCertManager | bool | `false` |  |
| global.elasticsearch.tlsencryption.verifySSL | bool | `false` |  |
| global.elasticsearch.workloadName | string | `""` |  |
| global.enableNetworkPolicy | bool | `false` |  |
| global.enablePostgresBackupJob | bool | `false` |  |
| global.enablePostgresMigration | bool | `false` |  |
| global.enablePostgresMigrationRendering | bool | `false` |  |
| global.enableRedisTlsUpgrade | bool | `true` |  |
| global.enableTLSProxies | bool | `false` |  |
| global.fastpathAggregator.enabled | bool | `false` |  |
| global.fipsCompliant | bool | `false` |  |
| global.gke.sqlproxy.enabled | bool | `false` |  |
| global.graphServicesEnabled | bool | `true` |  |
...
| global.iac.enableOci | bool | `true` |  |
| global.iac.enabled | bool | `true` |  |
| global.iac.environment | string | `"PRODUCTION"` |  |
| global.iac.graphdb.enabled | bool | `false` |  |
...
| global.iac.logLevel | string | `"info"` |  |
...
| global.infraRegistryName | string | `"quay.io"` |  |
| global.infraRepositoryPrefix | string | `"sysdig"` |  |
| global.ingressClassName | string | `"haproxy"` |  |
...
| global.installationType | string | `"onprem"` |  |
| global.internalIngestion.token | string | `""` |  |
| global.kafka.broker.externalPort | int | `9093` |  |
| global.kafka.broker.internalPort | int | `9092` |  |
| global.kafka.broker.readinessProbe.periodSeconds | int | `10` |  |
| global.kafka.broker.readinessProbe.timeoutSeconds | int | `30` |  |
| global.kafka.name | string | `"cp-kafka"` |  |
| global.kafka.namespace | string | `"sysdig"` |  |
| global.kafka.secure.caCrt | string | `""` |  |
| global.kafka.secure.caKey | string | `""` |  |
| global.kafka.secure.enabled | bool | `true` |  |
| global.kafka.secure.fipsmode | bool | `false` |  |
| global.kafka.secure.securityProtocol | string | `"SSL"` |  |
| global.kafka.secure.sslClientAuth | string | `"requested"` |  |
| global.kafka.secure.sslKeystorePassword | string | `""` |  |
| global.kafka.secure.sslTruststorePassword | string | `""` |  |
| global.kafka.secure.useCertManager | bool | `false` |  |
| global.kafka.serviceAccount | string | `"sysdig"` |  |
| global.kafkaCASecretName | string | `"kafka-ca-secret"` |  |
| global.kafkaCruiseControl.enabled | bool | `false` |  |
| global.kafkaOpts | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.admissionController.adminpassword | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.admissionController.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.agenthandler.admindb | string | `"anchore"` |  |
...
| global.legacyPostgres.postgresDatabases.agenthandler.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.agenthandler.username | string | `"agenthandler_user"` |  |
| global.legacyPostgres.postgresDatabases.agentsConf.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.agentsConf.adminpassword | string | `""` |  |
| global.legacyPostgres.postgresDatabases.agentsConf.adminusername | string | `"postgres"` |  |
...
| global.legacyPostgres.postgresDatabases.agentsConf.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.anchore.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.anchore.adminusername | string | `"postgres"` |  |
| global.legacyPostgres.postgresDatabases.anchore.host | string | `"sysdigcloud-postgresql"` |  |
| global.legacyPostgres.postgresDatabases.anchore.idletxtimeout | string | `"60min"` |  |
| global.legacyPostgres.postgresDatabases.anchore.port | string | `"5432"` |  |
| global.legacyPostgres.postgresDatabases.anchore.sslmode | string | `"disable"` |  |
| global.legacyPostgres.postgresDatabases.beacon.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.beacon.adminusername | string | `"postgres"` |  |
| global.legacyPostgres.postgresDatabases.beacon.db | string | `"beacon"` |  |
| global.legacyPostgres.postgresDatabases.beacon.host | string | `"sysdigcloud-postgresql"` |  |
| global.legacyPostgres.postgresDatabases.beacon.idletxtimeout | string | `"60min"` |  |
| global.legacyPostgres.postgresDatabases.beacon.port | string | `"5432"` |  |
| global.legacyPostgres.postgresDatabases.beacon.sslmode | string | `"disable"` |  |
| global.legacyPostgres.postgresDatabases.beacon.username | string | `"beacon_user"` |  |
| global.legacyPostgres.postgresDatabases.certman.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.certman.adminpassword | string | `""` |  |
| global.legacyPostgres.postgresDatabases.certman.adminusername | string | `"postgres"` |  |
| global.legacyPostgres.postgresDatabases.certman.db | string | `"certman"` |  |
...
| global.legacyPostgres.postgresDatabases.certman.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.certman.username | string | `"certman_user"` |  |
...
| global.legacyPostgres.postgresDatabases.clusteranalysis.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.clusteranalysis.adminpassword | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.clusteranalysis.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.clusteranalysis.username | string | `"clusteranalysis_user"` |  |
| global.legacyPostgres.postgresDatabases.compliance.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.compliance.adminpassword | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.compliance.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.cspmCompliance.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.cspmCompliance.adminpassword | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.cspmCompliance.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.cspmCompliance.username | string | `"cspmcompliance_user"` |  |
| global.legacyPostgres.postgresDatabases.eventsForwarder.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.eventsForwarder.adminpassword | string | `""` |  |
| global.legacyPostgres.postgresDatabases.eventsForwarder.adminusername | string | `"postgres"` |  |
| global.legacyPostgres.postgresDatabases.eventsForwarder.db | string | `"events_forwarder"` |  |
...
| global.legacyPostgres.postgresDatabases.eventsForwarder.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.eventsForwarder.username | string | `"events_forwarder_user"` |  |
| global.legacyPostgres.postgresDatabases.inventory.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.inventory.adminpassword | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.inventory.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.inventory.username | string | `"inventory_user"` |  |
| global.legacyPostgres.postgresDatabases.netsec.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.netsec.adminpassword | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.netsec.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.onboarding.adminpassword | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.onboarding.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.pkgMeta.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.pkgMeta.adminpassword | string | `""` |  |
| global.legacyPostgres.postgresDatabases.pkgMeta.adminusername | string | `"postgres"` |  |
| global.legacyPostgres.postgresDatabases.pkgMeta.db | string | `"scanningv2_pkgmeta"` |  |
...
| global.legacyPostgres.postgresDatabases.pkgMeta.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.pkgMeta.username | string | `"scanningv2_pkgmeta_user"` |  |
| global.legacyPostgres.postgresDatabases.platformAlerts.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.platformAlerts.adminpassword | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.platformAlerts.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.platformHva.admindb | string | `"postgres"` |  |
| global.legacyPostgres.postgresDatabases.platformHva.adminpassword | string | `""` |  |
| global.legacyPostgres.postgresDatabases.platformHva.adminusername | string | `"postgres"` |  |
| global.legacyPostgres.postgresDatabases.platformHva.appname | string | `"platform_hva"` |  |
| global.legacyPostgres.postgresDatabases.platformHva.connectMaxRetries | int | `10` |  |
| global.legacyPostgres.postgresDatabases.platformHva.connectMaxRetryDelay | string | `"30s"` |  |
| global.legacyPostgres.postgresDatabases.platformHva.connectRetryDelay | string | `"1s"` |  |
| global.legacyPostgres.postgresDatabases.platformHva.db | string | `"platform_hva"` |  |
| global.legacyPostgres.postgresDatabases.platformHva.forceSkipDownMigrations | bool | `false` |  |
| global.legacyPostgres.postgresDatabases.platformHva.host | string | `"sysdigcloud-postgresql"` |  |
| global.legacyPostgres.postgresDatabases.platformHva.idletxtimeout | string | `"60min"` |  |
| global.legacyPostgres.postgresDatabases.platformHva.migrationEnabled | bool | `true` |  |
| global.legacyPostgres.postgresDatabases.platformHva.migrationdir | string | `"/platform-service/hva/postgres/migrations"` |  |
| global.legacyPostgres.postgresDatabases.platformHva.password | string | `""` |  |
| global.legacyPostgres.postgresDatabases.platformHva.poolMaxConnectionsLife | string | `"3600s"` |  |
| global.legacyPostgres.postgresDatabases.platformHva.poolMaxIdleConnections | int | `20` |  |
| global.legacyPostgres.postgresDatabases.platformHva.poolMaxOpenConnections | int | `20` |  |
| global.legacyPostgres.postgresDatabases.platformHva.port | int | `5432` |  |
| global.legacyPostgres.postgresDatabases.platformHva.sslmode | string | `"disable"` |  |
| global.legacyPostgres.postgresDatabases.platformHva.username | string | `"platform_hva_user"` |  |
| global.legacyPostgres.postgresDatabases.platformZones.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.platformZones.adminpassword | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.platformZones.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.platformZonesMonitorDB.adminpassword | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.platformZonesPolicyDB.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.platformZonesPolicyDB.adminpassword | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.platformZonesPolicyDB.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.policies.adminpassword | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.policies.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.policy.admindb | string | `"anchore"` |  |
...
| global.legacyPostgres.postgresDatabases.policy.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.policy.username | string | `"policy_user"` |  |
| global.legacyPostgres.postgresDatabases.profiling.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.profiling.adminpassword | string | `""` |  |
| global.legacyPostgres.postgresDatabases.profiling.adminusername | string | `"postgres"` |  |
| global.legacyPostgres.postgresDatabases.profiling.db | string | `"profiling"` |  |
...
| global.legacyPostgres.postgresDatabases.profiling.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.promBeacon.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.promBeacon.adminpassword | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.promBeacon.idletxtimeout | string | `"60min"` |  |
| global.legacyPostgres.postgresDatabases.promBeacon.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.prwsInternalIngestion.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.prwsInternalIngestion.adminpassword | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.prwsInternalIngestion.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.quartz.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.quartz.adminpassword | string | `""` |  |
| global.legacyPostgres.postgresDatabases.quartz.adminusername | string | `"postgres"` |  |
...
| global.legacyPostgres.postgresDatabases.quartz.idletxtimeout | string | `"60min"` |  |
...
| global.legacyPostgres.postgresDatabases.quartz.sslmode | string | `"disable"` |  |
| global.legacyPostgres.postgresDatabases.quartz.username | string | `"quartz_user"` |  |
| global.legacyPostgres.postgresDatabases.queryStorageApi.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.queryStorageApi.adminpassword | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.queryStorageApi.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.rapidResponse.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.rapidResponse.adminpassword | string | `""` |  |
| global.legacyPostgres.postgresDatabases.rapidResponse.adminusername | string | `"postgres"` |  |
| global.legacyPostgres.postgresDatabases.rapidResponse.db | string | `"rapidresponse"` |  |
...
| global.legacyPostgres.postgresDatabases.rapidResponse.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.remoteStorage.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.remoteStorage.adminpassword | string | `""` |  |
| global.legacyPostgres.postgresDatabases.remoteStorage.adminusername | string | `"postgres"` |  |
| global.legacyPostgres.postgresDatabases.remoteStorage.db | string | `"remotestorage"` |  |
...
| global.legacyPostgres.postgresDatabases.remoteStorage.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.remoteStorage.username | string | `"remotestorage_user"` |  |
| global.legacyPostgres.postgresDatabases.reporting.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.reporting.adminusername | string | `"postgres"` |  |
| global.legacyPostgres.postgresDatabases.reporting.db | string | `"reporting"` |  |
| global.legacyPostgres.postgresDatabases.reporting.host | string | `"sysdigcloud-postgresql"` |  |
| global.legacyPostgres.postgresDatabases.reporting.idletxtimeout | string | `"60min"` |  |
| global.legacyPostgres.postgresDatabases.reporting.port | string | `"5432"` |  |
| global.legacyPostgres.postgresDatabases.reporting.sslmode | string | `"disable"` |  |
| global.legacyPostgres.postgresDatabases.reporting.username | string | `"reporting_user"` |  |
| global.legacyPostgres.postgresDatabases.resourceingestion.admindbname | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.resourceingestion.adminpassword | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.resourceingestion.host | string | `"sysdigcloud-postgresql"` |  |
...
| global.legacyPostgres.postgresDatabases.resourceingestion.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.resourceingestion.sslmode | string | `"disable"` |  |
| global.legacyPostgres.postgresDatabases.resourceingestion.username | string | `"resource_ingestion_user"` |  |
| global.legacyPostgres.postgresDatabases.responseActions.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.responseActions.adminusername | string | `"postgres"` |  |
| global.legacyPostgres.postgresDatabases.responseActions.db | string | `"responseactions"` |  |
...
| global.legacyPostgres.postgresDatabases.riskapi.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.riskapi.adminpassword | string | `""` |  |
| global.legacyPostgres.postgresDatabases.riskapi.adminusername | string | `"postgres"` |  |
| global.legacyPostgres.postgresDatabases.riskapi.db | string | `"risk"` |  |
| global.legacyPostgres.postgresDatabases.riskapi.host | string | `"sysdigcloud-postgresql"` |  |
| global.legacyPostgres.postgresDatabases.riskapi.password | string | `""` |  |
| global.legacyPostgres.postgresDatabases.riskapi.port | int | `5432` |  |
| global.legacyPostgres.postgresDatabases.riskapi.sslmode | string | `"disable"` |  |
| global.legacyPostgres.postgresDatabases.riskapi.username | string | `"riskuser"` |  |
| global.legacyPostgres.postgresDatabases.scanning.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.scanning.adminusername | string | `"postgres"` |  |
| global.legacyPostgres.postgresDatabases.scanning.db | string | `"scanning"` |  |
| global.legacyPostgres.postgresDatabases.scanning.host | string | `"sysdigcloud-postgresql"` |  |
| global.legacyPostgres.postgresDatabases.scanning.idletxtimeout | string | `"60min"` |  |
| global.legacyPostgres.postgresDatabases.scanning.port | string | `"5432"` |  |
| global.legacyPostgres.postgresDatabases.scanning.sslmode | string | `"disable"` |  |
| global.legacyPostgres.postgresDatabases.scanning.username | string | `"scanning_user"` |  |
| global.legacyPostgres.postgresDatabases.scanningv2Collector.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.scanningv2Collector.adminpassword | string | `""` |  |
| global.legacyPostgres.postgresDatabases.scanningv2Collector.adminusername | string | `"postgres"` |  |
...
| global.legacyPostgres.postgresDatabases.scanningv2Collector.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.scanningv2Credentialstore.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.scanningv2Credentialstore.adminpassword | string | `""` |  |
| global.legacyPostgres.postgresDatabases.scanningv2Credentialstore.adminusername | string | `"postgres"` |  |
...
| global.legacyPostgres.postgresDatabases.scanningv2Credentialstore.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.scanningv2Notifier.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.scanningv2Notifier.adminpassword | string | `""` |  |
| global.legacyPostgres.postgresDatabases.scanningv2Notifier.adminusername | string | `"postgres"` |  |
...
| global.legacyPostgres.postgresDatabases.scanningv2Notifier.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.scanningv2Policies.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.scanningv2Policies.adminpassword | string | `""` |  |
| global.legacyPostgres.postgresDatabases.scanningv2Policies.adminusername | string | `"postgres"` |  |
| global.legacyPostgres.postgresDatabases.scanningv2Policies.db | string | `"scanningv2_policies"` |  |
...
| global.legacyPostgres.postgresDatabases.scanningv2Policies.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.scanningv2Policies.username | string | `"scanningv2_policies_user"` |  |
| global.legacyPostgres.postgresDatabases.scanningv2RegistryScanner.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.scanningv2RegistryScanner.adminpassword | string | `""` |  |
| global.legacyPostgres.postgresDatabases.scanningv2RegistryScanner.adminusername | string | `"postgres"` |  |
...
| global.legacyPostgres.postgresDatabases.scanningv2RegistryScanner.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.scanningv2Reporting.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.scanningv2Reporting.adminpassword | string | `""` |  |
| global.legacyPostgres.postgresDatabases.scanningv2Reporting.adminusername | string | `"postgres"` |  |
...
| global.legacyPostgres.postgresDatabases.scanningv2Reporting.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.scanningv2Runtimeview.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.scanningv2Runtimeview.adminpassword | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.scanningv2Runtimeview.host | string | `"sysdigcloud-postgresql"` |  |
| global.legacyPostgres.postgresDatabases.scanningv2Runtimeview.idletxtimeout | string | `"60min"` |  |
| global.legacyPostgres.postgresDatabases.scanningv2Runtimeview.password | string | `""` |  |
| global.legacyPostgres.postgresDatabases.scanningv2Runtimeview.port | int | `5432` |  |
| global.legacyPostgres.postgresDatabases.scanningv2Runtimeview.sslmode | string | `"disable"` |  |
| global.legacyPostgres.postgresDatabases.scanningv2Runtimeview.username | string | `"scanningv2_runtimeview_user"` |  |
| global.legacyPostgres.postgresDatabases.scanningv2ScanRequestor.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.scanningv2ScanRequestor.adminpassword | string | `""` |  |
| global.legacyPostgres.postgresDatabases.scanningv2ScanRequestor.adminusername | string | `"postgres"` |  |
...
| global.legacyPostgres.postgresDatabases.scanningv2ScanRequestor.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.scanningv2Scanresults.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.scanningv2Scanresults.adminpassword | string | `""` |  |
| global.legacyPostgres.postgresDatabases.scanningv2Scanresults.adminusername | string | `"postgres"` |  |
| global.legacyPostgres.postgresDatabases.scanningv2Scanresults.db | string | `"scanningv2_scanresults"` |  |
...
| global.legacyPostgres.postgresDatabases.scanningv2Scanresults.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.scanningv2Scanresults.username | string | `"scanningv2_scanresults_user"` |  |
| global.legacyPostgres.postgresDatabases.scanningv2WorkloadDetector.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.scanningv2WorkloadDetector.adminpassword | string | `""` |  |
| global.legacyPostgres.postgresDatabases.scanningv2WorkloadDetector.adminusername | string | `"postgres"` |  |
...
| global.legacyPostgres.postgresDatabases.scanningv2WorkloadDetector.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.scanningv2riskmanager.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.scanningv2riskmanager.adminpassword | string | `""` |  |
| global.legacyPostgres.postgresDatabases.scanningv2riskmanager.adminusername | string | `"postgres"` |  |
| global.legacyPostgres.postgresDatabases.scanningv2riskmanager.db | string | `"scanningv2_riskmanager"` |  |
...
| global.legacyPostgres.postgresDatabases.scanningv2riskmanager.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.scanningv2riskmanager.username | string | `"scanningv2_riskmanager_user"` |  |
| global.legacyPostgres.postgresDatabases.scheduler.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.scheduler.adminusername | string | `"postgres"` |  |
| global.legacyPostgres.postgresDatabases.scheduler.db | string | `"scheduler"` |  |
...
| global.legacyPostgres.postgresDatabases.scheduler.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.scheduler.username | string | `"scheduler_user"` |  |
| global.legacyPostgres.postgresDatabases.sysdig.admindb | string | `"anchore"` |  |
| global.legacyPostgres.postgresDatabases.sysdig.adminpassword | string | `""` |  |
| global.legacyPostgres.postgresDatabases.sysdig.adminusername | string | `"postgres"` |  |
...
| global.legacyPostgres.postgresDatabases.ticketing.adminpassword | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.ticketing.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.workload.admindb | string | `"anchore"` |  |
...
| global.legacyPostgres.postgresDatabases.workload.password | string | `""` |  |
...
| global.legacyPostgres.postgresDatabases.workload.username | string | `"workload_user"` |  |
| global.legacyRedis.redisClientsMonitor.agent.tls | bool | `true` |  |
| global.legacyRedis.redisClientsMonitor.alerting.tls | bool | `true` |  |
...
| global.legacyRedis.redisClientsMonitor.ibmCache.tls | bool | `true` |  |
| global.legacyRedis.redisClientsMonitor.meerkat.tls | bool | `true` |  |
| global.legacyRedis.redisClientsMonitor.metering.tls | bool | `true` |  |
| global.legacyRedis.redisClientsMonitor.policiesCache.tls | bool | `true` |  |
| global.legacyRedis.redisClientsMonitor.promchap.tls | bool | `true` |  |
...
| global.legacyRedis.redisClientsSecure.cloudsec.tls | bool | `true` |  |
| global.legacyRedis.redisClientsSecure.compliance.tls | bool | `true` |  |
| global.legacyRedis.redisClientsSecure.events.tls | bool | `true` |  |
| global.legacyRedis.redisClientsSecure.eventsForwarder.tls | bool | `true` |  |
| global.legacyRedis.redisClientsSecure.fingerprints.tls | bool | `true` |  |
| global.legacyRedis.redisClientsSecure.forensic.tls | bool | `true` |  |
| global.legacyRedis.redisClientsSecure.inventory.password | string | `""` |  |
| global.legacyRedis.redisClientsSecure.inventory.pubCaCrt | string | `nil` |  |
| global.legacyRedis.redisClientsSecure.inventory.tls | bool | `true` |  |
| global.legacyRedis.redisClientsSecure.metadataEnricher.tls | bool | `true` |  |
| global.legacyRedis.redisClientsSecure.netsec.tls | bool | `true` |  |
| global.legacyRedis.redisClientsSecure.policies.tls | bool | `true` |  |
...
| global.legacyRedis.redisClientsSecure.profiling.tls | bool | `true` |  |
| global.legacyRedis.redisClientsSecure.profiling.user | string | `""` |  |
| global.legacyRedis.redisClientsSecure.rapidResponse.tls | bool | `true` |  |
| global.legacyRedis.redisClientsSecure.responseActions.tls | bool | `true` |  |
| global.legacyRedis.redisClientsSecure.scanning.password | string | `""` |  |
| global.legacyRedis.redisClientsSecure.scanning.pubCaCrt | string | `nil` |  |
| global.legacyRedis.redisClientsSecure.scanning.tls | bool | `true` |  |
| global.legacyRedis.redisClientsSecure.scheduler.tls | bool | `true` |  |
| global.legacyRedis.redisHa | bool | `true` |  |
| global.legacyRedis.redisTls.caCertExpiry | string | `"87660h"` |  |
| global.legacyRedis.redisTls.caCertRenewBefore | string | `"360h"` |  |
| global.legacyRedis.redisTls.caCrts | list | `[]` |  |
| global.legacyRedis.redisTls.caCrtsExternalSecretName | string | `""` |  |
| global.legacyRedis.redisTls.certificateIssuer | string | `"sysdig-selfsigned-issuer"` |  |
| global.legacyRedis.redisTls.certificateIssuerKind | string | `"ClusterIssuer"` |  |
| global.legacyRedis.redisTls.createIssuer | bool | `false` |  |
| global.legacyRedis.redisTls.deploy | bool | `true` |  |
| global.legacyRedis.redisTls.enabled | bool | `true` |  |
| global.legacyRedis.redisTls.endpoint | string | `"redistls"` |  |
| global.legacyRedis.redisTls.exporter.imageName | string | `"redis-exporter"` |  |
| global.legacyRedis.redisTls.exporter.version | string | `"v1.43.22-ubi"` |  |
| global.legacyRedis.redisTls.extraMasterConfig | string | `""` |  |
| global.legacyRedis.redisTls.extraRedisConfig | string | `""` |  |
| global.legacyRedis.redisTls.extraReplicaConfig | string | `""` |  |
| global.legacyRedis.redisTls.extraSentinelConfig | string | `""` |  |
| global.legacyRedis.redisTls.ha | bool | `false` |  |
| global.legacyRedis.redisTls.imageName | string | `"redis-7"` |  |
| global.legacyRedis.redisTls.imagePullSecret | string | `"sysdigcloud-pull-secret"` |  |
| global.legacyRedis.redisTls.nodeaffinityLabel | string | `""` |  |
| global.legacyRedis.redisTls.password | string | `""` |  |
| global.legacyRedis.redisTls.passwordExternalSecretKeyRef | object | `{}` |  |
| global.legacyRedis.redisTls.persistentVolumeClaim.size | string | `"100Gi"` |  |
| global.legacyRedis.redisTls.persistentVolumeClaim.storageClassName | string | `"sysdig"` |  |
| global.legacyRedis.redisTls.podAnnotations."cluster-autoscaler.kubernetes.io/safe-to-evict" | string | `"false"` |  |
| global.legacyRedis.redisTls.port | int | `6379` |  |
| global.legacyRedis.redisTls.privateKeyAlgorithm | string | `"RSA"` |  |
| global.legacyRedis.redisTls.privateKeySize | int | `4096` |  |
| global.legacyRedis.redisTls.probes.redis.liveness.failureThreshold | int | `5` |  |
| global.legacyRedis.redisTls.probes.redis.liveness.initialDelaySeconds | int | `180` |  |
| global.legacyRedis.redisTls.probes.redis.readiness.failureThreshold | int | `5` |  |
| global.legacyRedis.redisTls.probes.redis.readiness.initialDelaySeconds | int | `50` |  |
| global.legacyRedis.redisTls.probes.sentinel.liveness.failureThreshold | int | `20` |  |
| global.legacyRedis.redisTls.probes.sentinel.liveness.initialDelaySeconds | int | `300` |  |
| global.legacyRedis.redisTls.probes.sentinel.readiness.failureThreshold | int | `5` |  |
| global.legacyRedis.redisTls.probes.sentinel.readiness.initialDelaySeconds | int | `50` |  |
| global.legacyRedis.redisTls.pubCaCrts | list | `[]` |  |
| global.legacyRedis.redisTls.pubCaCrtsExternalSecretName | string | `""` |  |
| global.legacyRedis.redisTls.registryName | string | `"quay.io"` |  |
| global.legacyRedis.redisTls.repositoryPrefix | string | `"sysdig"` |  |
| global.legacyRedis.redisTls.resources.redis-init.limits.cpu | string | `"300m"` |  |
| global.legacyRedis.redisTls.resources.redis-init.limits.memory | string | `"200Mi"` |  |
| global.legacyRedis.redisTls.resources.redis-init.requests.cpu | string | `"50m"` |  |
| global.legacyRedis.redisTls.resources.redis-init.requests.memory | string | `"100Mi"` |  |
| global.legacyRedis.redisTls.resources.redis-metrics.limits.cpu | string | `"100m"` |  |
| global.legacyRedis.redisTls.resources.redis-metrics.limits.memory | string | `"128Mi"` |  |
| global.legacyRedis.redisTls.resources.redis-metrics.requests.cpu | string | `"50m"` |  |
| global.legacyRedis.redisTls.resources.redis-metrics.requests.memory | string | `"64Mi"` |  |
| global.legacyRedis.redisTls.resources.redis-sentinel.limits.cpu | string | `"300m"` |  |
| global.legacyRedis.redisTls.resources.redis-sentinel.limits.memory | string | `"100Mi"` |  |
| global.legacyRedis.redisTls.resources.redis-sentinel.requests.cpu | string | `"50m"` |  |
| global.legacyRedis.redisTls.resources.redis-sentinel.requests.memory | string | `"100Mi"` |  |
| global.legacyRedis.redisTls.resources.redis.limits.cpu | int | `2` |  |
| global.legacyRedis.redisTls.resources.redis.limits.memory | string | `"2Gi"` |  |
| global.legacyRedis.redisTls.resources.redis.requests.cpu | string | `"100m"` |  |
| global.legacyRedis.redisTls.resources.redis.requests.memory | string | `"2Gi"` |  |
| global.legacyRedis.redisTls.resources.redistls_upgrade.limits.cpu | int | `2` |  |
| global.legacyRedis.redisTls.resources.redistls_upgrade.limits.memory | string | `"2Gi"` |  |
| global.legacyRedis.redisTls.resources.redistls_upgrade.requests.cpu | string | `"200m"` |  |
| global.legacyRedis.redisTls.resources.redistls_upgrade.requests.memory | string | `"2Gi"` |  |
| global.legacyRedis.redisTls.sentinel.enabled | bool | `false` |  |
| global.legacyRedis.redisTls.sentinel.imageName | string | `"redis-sentinel-7"` |  |
| global.legacyRedis.redisTls.sentinel.masterSet | string | `"primary"` |  |
| global.legacyRedis.redisTls.sentinel.port | int | `26379` |  |
| global.legacyRedis.redisTls.sentinel.version | string | `"0.1.6"` |  |
| global.legacyRedis.redisTls.serviceAccountName | string | `"redis"` |  |
| global.legacyRedis.redisTls.tls | bool | `true` |  |
| global.legacyRedis.redisTls.updateStrategy | string | `"RollingUpdate"` |  |
...
| global.legacyRedis.redisTls.version | string | `"0.1.8"` |  |
| global.legacyRedis.sysdigRedis.deploy | bool | `false` |  |
| global.legacyRedis.sysdigRedis.endpoint | string | `"redis"` |  |
| global.legacyRedis.sysdigRedis.imagePullSecret | string | `"sysdigcloud-pull-secret"` |  |
...
| global.legacyRedis.sysdigRedis.serviceAccountName | string | `"sysdig"` |  |
| global.legacyRedis.sysdigRedis.username | string | `""` |  |
| global.legacyRedis.useCertManager | bool | `false` |  |
| global.legacyRedis.useRedisTls | bool | `true` |  |
| global.legacyS3.s3.capturesFolder | string | `""` |  |
...
| global.legacyS3.s3.scanRequestor.accessKeyId | string | `"scanningv2_scanrequestor"` |  |
...
| global.meerkat.collectorProgressDeadline | int | `1800` |  |
| global.meerkat.datastreamEnabled | bool | `false` |  |
...
| global.meerkat.objectStorage.bucket | string | `"sysdig-meerkat-storage"` |  |
| global.meerkat.objectStorage.customPrefix | string | `""` |  |
...
| global.meerkat.store.dataRetention.byCustomer | bool | `true` |  |
...
| global.meerkat.store.useCassandraGPartTablePerSampling | bool | `false` |  |
| global.metadataService.discoveryJobEnabled | bool | `true` |  |
| global.metadataService.enabled | bool | `true` |  |
| global.monitor | string | `nil` |  |
| global.monitorAdvisor.enabled | bool | `true` |  |
| global.monitorRegistryName | string | `"quay.io"` |  |
| global.monitorRepositoryPrefix | string | `"sysdig"` |  |
...
| global.nats.secure.enabled | bool | `true` |  |
| global.natsBoxVersion | string | `"0.19.3-0.0.58"` |  |
| global.natsExporterVersion | string | `"0.18.0-0.1.43"` |  |
| global.natsReloaderVersion | string | `"0.14.3-0.1.45"` |  |
| global.natsServerVersion | string | `"2.11.4-0.1.47"` |  |
| global.neo4j.certManager.enabled | bool | `false` |  |
| global.neo4jDatabases.graphingestion.adminpassword | string | `""` |  |
| global.neo4jDatabases.graphingestion.adminusername | string | `"ingestion_admin"` |  |
| global.neo4jDatabases.graphingestion.db | string | `"neo4j"` |  |
| global.neo4jDatabases.graphingestion.endpoint | string | `"neo4j+ssc://neo4j-internals.sysdig.svc.cluster.local:7687"` |  |
| global.neo4jDatabases.graphingestion.maxConnectionPoolSize | int | `100` |  |
| global.neo4jDatabases.graphingestion.password | string | `""` |  |
| global.neo4jDatabases.graphingestion.tx_timeout | string | `"120s"` |  |
| global.neo4jDatabases.graphingestion.username | string | `"ingestion"` |  |
| global.neo4jDatabases.graphquery.adminpassword | string | `""` |  |
| global.neo4jDatabases.graphquery.adminusername | string | `"ingestion_admin"` |  |
| global.neo4jDatabases.graphquery.db | string | `"neo4j"` |  |
| global.neo4jDatabases.graphquery.endpoint | string | `"neo4j+ssc://neo4j-internals.sysdig.svc.cluster.local:7687"` |  |
| global.neo4jDatabases.graphquery.password | string | `""` |  |
| global.neo4jDatabases.graphquery.username | string | `"query"` |  |
| global.neo4jDatabases.onprem.graphingestion.adminpassword | string | `""` |  |
| global.neo4jDatabases.onprem.graphingestion.adminusername | string | `"notNeeded"` |  |
...
| global.neo4jDatabases.onprem.graphingestion.password | string | `""` |  |
| global.neo4jDatabases.onprem.graphingestion.tx_timeout | string | `"120s"` |  |
| global.neo4jDatabases.onprem.graphingestion.username | string | `"notNeeded"` |  |
| global.neo4jDatabases.risk.adminusername | string | `"neo4j"` |  |
| global.neo4jDatabases.risk.endpoint | string | `""` |  |
| global.neo4jDatabases.risk.loglevel | string | `"INFO"` |  |
| global.neo4jDatabases.risk.password | string | `""` |  |
| global.neo4jDatabases.risk.username | string | `"risk"` |  |
| global.neo4jDatabases.riskengine.username | string | `"riskengine"` |  |
| global.neo4jDatabases.streamTimeoutPerRowSecs | int | `30` |  |
| global.networkEncryption.controlPlane.identity.issuer.scheme | string | `"linkerd.io/tls"` |  |
| global.networkEncryption.controlPlane.imageVersions.cniPlugin | string | `"2.0.9"` |  |
| global.networkEncryption.controlPlane.imageVersions.controller | string | `"2.0.16"` |  |
| global.networkEncryption.controlPlane.imageVersions.debug | string | `"2.0.9"` |  |
| global.networkEncryption.controlPlane.imageVersions.policyController | string | `"2.0.17"` |  |
| global.networkEncryption.controlPlane.imageVersions.proxy | string | `"2.0.18"` |  |
| global.networkEncryption.controlPlane.imageVersions.proxyInit | string | `"2.0.18"` |  |
| global.networkEncryption.enabled | bool | `false` |  |
| global.networkEncryption.linkerdAwaitImageVersion | string | `"2.0.10"` |  |
| global.nginxVersion | string | `"6.12.5"` |  |
| global.nodeLabelsImageName | string | `"node-labels-to-files"` |  |
| global.nodeLabelsVersion | string | `"1.0.70"` |  |
...
| global.postgresBackupJobName | string | `"sysdigcloud-postgresql-backup-job"` |  |
| global.postgresImageName | string | `"postgres-15"` |  |
| global.postgresImageVersion | string | `"0.1.14"` |  |
| global.postgresMigrationImageName | string | `"onprem_migration"` |  |
| global.postgresMigrationImageVersion | string | `"0.1.8-postgresql-upgrade-12-to-15"` |  |
| global.postgresVersion | string | `"0.1.14"` |  |
...
| global.proxy.defaultNoProxy | string | `"127.0.0.1, localhost, sysdigcloud-anchore-core, sysdigcloud-anchore-api, sysdigcloud-anchore-catalog, sysdigcloud-anchore-policy-engine, anchore-reports, sysdigcloud-api, sysdigcloud-events-ingestion, sysdigcloud-scanningv2-airgap-vuln-feeds-http, sysdigcloud-scanningv2-agents-conf-grpc, sysdigcloud-scanningv2-credentialstore-api-grpc, sysdigcloud-scanningv2-credentialstore-api-grpc-headless, sysdigcloud-scanningv2-pkgmeta-api-grpc, sysdigcloud-scanningv2-policies-api-grpc, sysdigcloud-scanningv2-reporting-scheduler-grpc, sysdigcloud-scanningv2-riskmanager-api-grpc, sysdigcloud-scanningv2-sbom-api-grpc-headless, sysdigcloud-scanningv2-scanrequestor-grpc-headless, sysdigcloud-scanningv2-scanresults-api-grpc, sysdigcloud-scanningv2-vulns-api-grpc, sysdigcloud-scanningv2-vulns-api-grpc-headless"` |  |
| global.proxy.enable | bool | `false` |  |
| global.proxy.noProxy | string | `""` |  |
| global.proxy.port | int | `80` |  |
| global.proxy.protocol | string | `"http"` |  |
| global.quickwit.auth.basicAuth.password | string | `""` |  |
...
| global.redistlsCASecretName | string | `"redistls-ca-secret"` |  |
...
| global.sageUsageFetching.url | string | `"http://sysdig-copilot:8000"` |  |
...
| global.scanningv2.proxy.port | int | `80` |  |
| global.scanningv2.proxy.protocol | string | `"http"` |  |
| global.scanningv2.telemetry.clusterName | string | `"sysdigcloud"` |  |
...
| global.secure.artifactDeployer.enabled | bool | `true` |  |
| global.secure.artifactDeployer.schedule | string | `"0 12 * * *"` |  |
| global.secure.artifactDeployer.tag | string | `""` |  |
| global.secure.backend.isEuRegion | bool | `false` |  |
| global.secure.backend.url | string | `"http://sysdigcloud-api:8080"` |  |
| global.secure.cloudOnboardingConfig.aws.cdr.ebEnabled | bool | `false` |  |
| global.secure.cloudOnboardingConfig.aws.cdr.s3Enabled | bool | `false` |  |
| global.secure.cloudOnboardingConfig.aws.gov.cdr.ebEnabled | bool | `false` |  |
| global.secure.cloudOnboardingConfig.aws.gov.cdr.s3Enabled | bool | `false` |  |
...
| global.secure.compliance.serviceToken | string | `""` |  |
| global.secure.compliance.useAuthorizationService | bool | `false` |  |
| global.secure.db.password | string | `""` |  |
...
| global.secure.iac.policyService.endpoint | string | `"sysdigcloud-platform-zones-service-grpc:8091"` |  |
...
| global.secureOnly | bool | `false` |  |
| global.secureRegistryName | string | `"quay.io"` |  |
| global.secureRepositoryPrefix | string | `"sysdig"` |  |
| global.slack.client.endpoint | string | `"https://slack.com/oauth/v2/authorize"` |  |
| global.slack.client.id | string | `"awesomeclientid"` |  |
| global.slack.client.oauth.endpoint | string | `"https://slack.com/api/oauth.v2.access"` |  |
| global.slack.client.scope | string | `"incoming-webhook"` |  |
| global.slack.client.secret | string | `"awesomeclientsecret"` |  |
...
| global.tlsencryption.adminUser.password | string | `""` |  |
| global.tlsencryption.readonly.password | string | `""` |  |
| global.tlsencryption.trtUser.password | string | `""` |  |
...
| global.uiRegistryName | string | `"quay.io"` |  |
| global.uiRepositoryPrefix | string | `"sysdig"` |  |
| global.uiVersion | string | `""` |  |
| global.useHelm | bool | `true` |  |
| global.useIngressV2 | bool | `true` |  |
| global.zones.enabled | bool | `true` |  |
| global.zones.endpoint | string | `"sysdigcloud-platform-zones-service-grpc:8091"` |  |
| global.zones.platformService.endpoint | string | `"sysdigcloud-platform-zones-service-grpc:8091"` |  |
| global.zones.platformService.tlsSkip | bool | `true` |  |
| global.zones.tlsSkip | bool | `true` |  |
...
![Version: 5.1.0-260615121405-main-vc70a4c4](https://img.shields.io/badge/Version-5.1.0--260615121405--main--vc70a4c4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 1.0.0-260604082922-main-vaee0c5f](https://img.shields.io/badge/Version-1.0.0--260604082922--main--vaee0c5f-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 0.99.0-main.2026-07-10T09-49-55Z.ved04014](https://img.shields.io/badge/Version-0.99.0--main.2026--07--10T09--49--55Z.ved04014-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| oci://us-docker.pkg.dev/sysdig-artifact-registry-dev/gar-charts | linkerd-partials | 0.0.5 |
| oci://us-docker.pkg.dev/sysdig-artifact-registry-dev/gar-charts | sysdig-template | 1.15.1 |
...
![Version: 1.1.0-260622211936-main-veda677a](https://img.shields.io/badge/Version-1.1.0--260622211936--main--veda677a-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| analytics.janitor.schedule | string | `"0 1,13 * * *"` |  |
...
![Version: 4.1.0-260630144517-main-v16dd666](https://img.shields.io/badge/Version-4.1.0--260630144517--main--v16dd666-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| api.keda.cooldownPeriod | int | `300` |  |
| api.keda.enabled | bool | `false` |  |
| api.keda.maxReplicaCount | int | `5` |  |
| api.keda.minReplicaCount | int | `2` |  |
| api.keda.pollingInterval | int | `60` |  |
| api.keda.scaleDown.periodSeconds | int | `300` |  |
| api.keda.scaleDown.stabilizationWindowSeconds | int | `3600` |  |
| api.keda.scaleDown.value | int | `1` |  |
| api.keda.scaleUp.periodSeconds | int | `60` |  |
| api.keda.scaleUp.stabilizationWindowSeconds | int | `120` |  |
| api.keda.scaleUp.value | int | `1` |  |
...
| global.api.serviceTokens.securePostureEngineService.serviceToken | string | `nil` |  |
...
![Version: 1.0.20260619-v6def751](https://img.shields.io/badge/Version-1.0.20260619--v6def751-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| beaconPromRemoteWrite.keda.cooldownPeriod | int | `300` |  |
| beaconPromRemoteWrite.keda.enabled | bool | `false` |  |
| beaconPromRemoteWrite.keda.maxReplicaCount | int | `6` |  |
| beaconPromRemoteWrite.keda.minReplicaCount | int | `2` |  |
| beaconPromRemoteWrite.keda.pollingInterval | int | `30` |  |
| beaconPromRemoteWrite.keda.restoreToOriginalReplicaCount | bool | `false` |  |
| beaconPromRemoteWrite.keda.scaleDown.periodSeconds | int | `300` |  |
| beaconPromRemoteWrite.keda.scaleDown.stabilizationWindowSeconds | int | `3600` |  |
| beaconPromRemoteWrite.keda.scaleDown.value | int | `1` |  |
| beaconPromRemoteWrite.keda.scaleUp.periodSeconds | int | `60` |  |
| beaconPromRemoteWrite.keda.scaleUp.stabilizationWindowSeconds | int | `120` |  |
| beaconPromRemoteWrite.keda.scaleUp.value | int | `1` |  |
...
| cassandra.cassandraExporterVersion | string | `"v1.0.24-ubi"` |  |
| cassandra.cassandraImage | string | `"cassandra"` |  |
| cassandra.cassandraVersion | string | `"4.1.11-0.5.0"` |  |
...
| cassandra.multiCluster.sidecarProxyImageVersion | string | `"6.12.44"` |  |
...
![Version: 5.2.0-260629081617-main-ve23dff1](https://img.shields.io/badge/Version-5.2.0--260629081617--main--ve23dff1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 1.5.2](https://img.shields.io/badge/Version-1.5.2-informational?style=flat-square) ![AppVersion: 26.2.5.45](https://img.shields.io/badge/AppVersion-26.2.5.45-informational?style=flat-square)
...
| clickhouseKeeper.clickhouseKeeperVersion | string | `"1.2.16"` |  |
...
![Version: 1.5.14](https://img.shields.io/badge/Version-1.5.14-informational?style=flat-square) ![AppVersion: 26.2.5.45](https://img.shields.io/badge/AppVersion-26.2.5.45-informational?style=flat-square)
...
| clickhouseShards.clickhouseBackupFIPSVersion | string | `"1.0.32-fips"` |  |
| clickhouseShards.clickhouseBackupIBMVersion | string | `"1.0.33-ibm"` |  |
| clickhouseShards.clickhouseBackupImage | string | `"clickhouse-backup"` |  |
| clickhouseShards.clickhouseBackupVersion | string | `"1.0.31"` |  |
...
| clickhouseShards.clickhouseVersion | string | `"1.2.16"` |  |
...
| clickhouseShards.shardOverrides | object | `{}` |  |
...
![Version: 5.0.0-260630131214-main-v1759bbf](https://img.shields.io/badge/Version-5.0.0--260630131214--main--v1759bbf-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 1.1.20260608-v947e52d](https://img.shields.io/badge/Version-1.1.20260608--v947e52d-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| Key | Type | Default | Description |
|-----|------|---------|-------------|
| collector.agentVersionSettings.minAgentVersions.agentino | string | `""` |  |
| collector.agentVersionSettings.minAgentVersions.agentone | string | `""` |  |
| collector.agentVersionSettings.minAgentVersions.k8s_audit_agent | string | `""` |  |
| collector.agentVersionSettings.minAgentVersions.k8s_metadata_agent | string | `""` |  |
| collector.agentVersionSettings.minAgentVersions.linux | string | `""` |  |
| collector.agentVersionSettings.minAgentVersions.windows | string | `""` |  |
...
| collector.hpa.enabled | bool | `false` |  |
| collector.jvmOptions | string | `""` |  |
| collector.keda.cooldownPeriod | int | `600` |  |
| collector.keda.enabled | bool | `false` |  |
| collector.keda.maxReplicaCount | int | `10` |  |
| collector.keda.minReplicaCount | int | `2` |  |
| collector.keda.pollingInterval | int | `300` |  |
| collector.keda.scaleDown.periodSeconds | int | `600` |  |
| collector.keda.scaleDown.stabilizationWindowSeconds | int | `600` |  |
| collector.keda.scaleDown.value | int | `1` |  |
| collector.keda.scaleUp.periodSeconds | int | `60` |  |
| collector.keda.scaleUp.stabilizationWindowSeconds | int | `0` |  |
| collector.keda.scaleUp.value | int | `3` |  |
...
| global.nginxVersion | string | `"6.12.53"` |  |
| global.prometheus.enabled | bool | `true` |  |
| global.scaler.authenticationRef | string | `""` |  |
| global.scaler.clusterName | string | `""` |  |
| global.scaler.serverAddress | string | `""` |  |
...
![Version: 5.0.0-260708000055-main-v59f13c9](https://img.shields.io/badge/Version-5.0.0--260708000055--main--v59f13c9-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 0.10.0](https://img.shields.io/badge/Version-0.10.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.10.0](https://img.shields.io/badge/AppVersion-1.10.0-informational?style=flat-square)
...
| elasticsearchExporter.imageTag | string | `"1.10.0-r9"` | es exporter image tag |
| elasticsearchExporter.nodeAffinity | list | `[]` | Add required nodeAffinity rules |
| elasticsearchExporter.registryName | string | `"us-docker.pkg.dev"` | default registry name |
| elasticsearchExporter.repositoryPrefix | string | `"sysdig-artifact-registry-dev/gar-docker/infra"` | default repository prefix |
...
![Version: 0.11.2](https://img.shields.io/badge/Version-0.11.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.19.2](https://img.shields.io/badge/AppVersion-2.19.2-informational?style=flat-square)
...
| elasticsearch.opensearchVersion | string | `"2.19.6-r1"` | opensearch image tag |
...
![Version: 5.2.1-260708150747-main-v589ee28](https://img.shields.io/badge/Version-5.2.1--260708150747--main--v589ee28-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 5.1.0-260708164843-main-vc5339e3](https://img.shields.io/badge/Version-5.1.0--260708164843--main--vc5339e3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 4.0.1-260707233332-main-v248f0f1](https://img.shields.io/badge/Version-4.0.1--260707233332--main--v248f0f1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 5.2.0-260707131259-main-vcdf97e8](https://img.shields.io/badge/Version-5.2.0--260707131259--main--vcdf97e8-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| fingerprints.skaffold | object | `{}` |  |
| fingerprints.skippedCustomers | string | `""` |  |
| fingerprints.store.bf.capacity | string | `"150"` |  |
| fingerprints.store.bf.expansion | string | `"2"` |  |
| fingerprints.store.bf.falsePositiveProb | string | `"1e-10"` |  |
| fingerprints.store.bf.hardLimit | string | `"1500"` |  |
| fingerprints.store.bf.redisTTL | string | `"6h"` |  |
| fingerprints.store.bf.useHash | bool | `false` |  |
...
![Version: 1.9.18](https://img.shields.io/badge/Version-1.9.18-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.0.0](https://img.shields.io/badge/AppVersion-1.0.0-informational?style=flat-square)
...
![Version: 1.2.392-260625101828-main-vde54b0f](https://img.shields.io/badge/Version-1.2.392--260625101828--main--vde54b0f-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 2.4.22](https://img.shields.io/badge/Version-2.4.22-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.5.146](https://img.shields.io/badge/AppVersion-2.5.146-informational?style=flat-square)
...
| Key | Type | Default | Description |
|-----|------|---------|-------------|
| global.airgappedRegistryName | string | `nil` | registry name for airgapped environments; takes highest precedence |
| global.airgappedRepositoryPrefix | string | `nil` | repository prefix for airgapped environments; takes highest precedence |
| global.infraRegistryName | string | `nil` | override the default cruise-control registry name (e.g. an internal GAR for non-airgapped clusters); checked after airgapped overrides |
| global.infraRepositoryPrefix | string | `nil` | override the default cruise-control repository prefix; checked after airgapped overrides |
| global.kafka.broker.internalPort | int | `9092` |  |
| global.kafka.name | string | `"cp-kafka"` |  |
...
| kafkaCruiseControl.image.tag | string | `"2.4.51"` |  |
...
![Version: 3.6.28](https://img.shields.io/badge/Version-3.6.28-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 7.9.7](https://img.shields.io/badge/AppVersion-7.9.7-informational?style=flat-square)
...
| kafka.broker.livenessProbe.failureThreshold | int | `3` | kafka liveness probe failure threshold |
| kafka.broker.livenessProbe.periodSeconds | int | `30` | kafka liveness probe frequency of checks |
| kafka.broker.livenessProbe.timeoutSeconds | int | `15` | kafka liveness probe timeout; needs headroom for the kafka CLI JVM startup |
...
| kafka.kafkaExporterVersion | string | `"v1.0.25-ubi"` | jmx exporter image name |
| kafka.livenessProbeCommand | list | `["/liveness-check.sh"]` | liveness probe exec command. When non-empty, replaces the legacy tcpSocket probe with an exec. The bundled `/liveness-check.sh` bypasses linkerd-proxy via loopback and exercises the broker directly via `kafka-broker-api-versions`. Safe by default because the chart pins `kafka.version` to a cp-kafka-7 image that includes the script. To fall back to the legacy tcpSocket probe (e.g. when consuming the chart with a downstream override that pins an older cp-kafka-7 image without /liveness-check.sh), set `kafka.livenessProbeCommand: []` in your values overlay. |
...
| kafka.nodeLabelsVersion | string | `"1.0.77"` |  |
...
| kafka.version | string | `"1.6.50"` | kafka image tag |
...
| meerkatAggregator.worker.keda.cooldownPeriod | int | `300` |  |
| meerkatAggregator.worker.keda.delay600sThreshold | string | `"13"` |  |
| meerkatAggregator.worker.keda.delay60sThreshold | string | `"2100"` |  |
| meerkatAggregator.worker.keda.enabled | bool | `false` |  |
| meerkatAggregator.worker.keda.maxReplicaCount | int | `2` |  |
| meerkatAggregator.worker.keda.minReplicaCount | int | `1` |  |
| meerkatAggregator.worker.keda.pollingInterval | int | `30` |  |
| meerkatAggregator.worker.keda.scaleDown.periodSeconds | int | `180` |  |
| meerkatAggregator.worker.keda.scaleDown.stabilizationWindowSeconds | int | `900` |  |
| meerkatAggregator.worker.keda.scaleDown.value | int | `1` |  |
| meerkatAggregator.worker.keda.scaleUp.periodSeconds | int | `1800` |  |
| meerkatAggregator.worker.keda.scaleUp.stabilizationWindowSeconds | int | `600` |  |
| meerkatAggregator.worker.keda.scaleUp.value | int | `1` |  |
...
| meerkatDatastream.keda.cooldownPeriod | int | `300` |  |
| meerkatDatastream.keda.enabled | bool | `false` |  |
| meerkatDatastream.keda.maxReplicaCount | int | `6` |  |
| meerkatDatastream.keda.minReplicaCount | int | `2` |  |
| meerkatDatastream.keda.pollingInterval | int | `60` |  |
| meerkatDatastream.keda.scaleDown.periodSeconds | int | `1200` |  |
| meerkatDatastream.keda.scaleDown.stabilizationWindowSeconds | int | `1800` |  |
| meerkatDatastream.keda.scaleDown.value | int | `2` |  |
| meerkatDatastream.keda.scaleUp.periodSeconds | int | `600` |  |
| meerkatDatastream.keda.scaleUp.stabilizationWindowSeconds | int | `300` |  |
| meerkatDatastream.keda.scaleUp.value | int | `3` |  |
...
![Version: 0.2.0-260702085504-main-v5376d52](https://img.shields.io/badge/Version-0.2.0--260702085504--main--v5376d52-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 2.2.0-260708140207-main-ve0eeb0d](https://img.shields.io/badge/Version-2.2.0--260708140207--main--ve0eeb0d-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| metadataService.mdsOperatorVersion | string | `"1.5.109-v8a7349c"` |  |
...
![Version: 0.1.82](https://img.shields.io/badge/Version-0.1.82-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.11.4](https://img.shields.io/badge/AppVersion-2.11.4-informational?style=flat-square)
...
|-----|------|---------|-------------|
| global.cloudProvider.isMultiAZ | bool | `false` |  |
| global.datastoreStorageOverrides.nats.size | string | `""` | Override the NATS JetStream persistent volume size |
| global.datastoreStorageOverrides.nats.storageClass | string | `""` | Override the storage class used for NATS JetStream persistent volumes |
| global.enableNetworkPolicy | bool | `false` |  |
| global.fipsCompliant | bool | `false` |  |
| global.nats.certManager.certs[0].additionalSubjectAltNames.dns | list | `[]` |  |
| global.nats.certManager.certs[0].additionalSubjectAltNames.uris | list | `[]` |  |
...
| global.natsBoxVersion | string | `"0.19.3-0.1.14"` |  |
| global.natsExporterVersion | string | `"0.19.2-0.1.59"` |  |
| global.natsReloaderVersion | string | `"0.14.3-0.1.61"` |  |
| global.natsServerVersion | string | `"2.11.4-0.1.66"` |  |
| global.storageClassName | string | `"sysdig"` |  |
...
| neo4jBox.extraEnv[0].name | string | `"JAVA_OPTS"` |  |
| neo4jBox.extraEnv[0].value | string | `"-XX:TieredStopAtLevel=1 -Xmx512m -Xms128m"` |  |
...
| neo4jBox.resources.limits.cpu | string | `"500m"` |  |
| neo4jBox.resources.limits.memory | string | `"1Gi"` |  |
| neo4jBox.resources.requests.cpu | string | `"100m"` |  |
| neo4jBox.resources.requests.memory | string | `"256Mi"` |  |
...
![Version: 5.0.1-260630225811-main-ve06e6db](https://img.shields.io/badge/Version-5.0.1--260630225811--main--ve06e6db-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 4.2.4](https://img.shields.io/badge/Version-4.2.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.0.0](https://img.shields.io/badge/AppVersion-1.0.0-informational?style=flat-square)
...
| networkPolicies.ingress.alb.selector | map | `{}` | A podSelector expression to identify ALB deployment(s) to permit traffic from; make it `null` to exclude ALBs from generated rules |
...
| networkPolicies.ingress.emissary.selector | map | `{"matchLabels":{"app.kubernetes.io/instance":"emissary"}}` | A podSelector expression to identify Emissary deployment(s) to permit traffic from; make it `null` to exclude Emissary from generated rules |
| networkPolicies.ingress.haproxy.selector | map | `{"matchExpressions":[{"key":"run","operator":"In","values":["haproxy-ingress"]}]}` | A podSelector expression to identify HAproxy deployment(s) to permit traffic from; make it `null` to exclude HAproxy from generated rules |
| networkPolicies.ingress.teleportAgentNamespace | string | `"teleport-agent"` | Namespace of the teleport-kube-agent, permitted to reach the in-cluster spilo Postgres clusters (for `tsh db connect`). Defaults to "teleport-agent". |

# onboarding

![Version: 5.0.0-260630140811-main-ve0906dc](https://img.shields.io/badge/Version-5.0.0--260630140811--main--ve0906dc-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| onboarding.componentHealthAlert.interval | string | `"15m"` |  |
...
![Version: 0.0.1-260707081327-main-v4be5605](https://img.shields.io/badge/Version-0.0.1--260707081327--main--v4be5605-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.0.1-260707081327-main-v4be5605](https://img.shields.io/badge/AppVersion-0.0.1--260707081327--main--v4be5605-informational?style=flat-square)
...
![Version: 0.0.1-260703144519-main-v2b694cd](https://img.shields.io/badge/Version-0.0.1--260703144519--main--v2b694cd-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.0.1-260703144519-main-v2b694cd](https://img.shields.io/badge/AppVersion-0.0.1--260703144519--main--v2b694cd-informational?style=flat-square)
...
|-----|------|---------|-------------|
| global.api.serviceTokens.platformService.alerts.serviceToken | string | `nil` |  |
| global.api.serviceTokens.platformService.hva.serviceToken | string | `nil` |  |
| global.api.serviceTokens.platformService.zones.serviceToken | string | `nil` |  |
| global.apps | string | `"monitor"` |  |
| global.gke.sqlproxy.enabled | bool | `false` |  |
| global.infraRepositoryPrefix | string | `"infra"` |  |
...
| global.legacyPostgres.postgresDatabases.platformAlerts.username | string | `"platform_alerts_user"` |  |
| global.legacyPostgres.postgresDatabases.platformHva.admindb | string | `"postgres"` |  |
| global.legacyPostgres.postgresDatabases.platformHva.adminpassword | string | `nil` |  |
| global.legacyPostgres.postgresDatabases.platformHva.adminusername | string | `"postgres"` |  |
| global.legacyPostgres.postgresDatabases.platformHva.appname | string | `"platform_hva"` |  |
| global.legacyPostgres.postgresDatabases.platformHva.connectMaxRetries | int | `10` |  |
| global.legacyPostgres.postgresDatabases.platformHva.connectMaxRetryDelay | string | `"30s"` |  |
...
| global.legacyPostgres.postgresDatabases.platformHva.migrationEnabled | bool | `true` |  |
| global.legacyPostgres.postgresDatabases.platformHva.migrationdir | string | `"/platform-service/hva/postgres/migrations"` |  |
| global.legacyPostgres.postgresDatabases.platformHva.password | string | `nil` |  |
| global.legacyPostgres.postgresDatabases.platformHva.poolMaxConnectionsLife | string | `"3600s"` |  |
| global.legacyPostgres.postgresDatabases.platformHva.poolMaxIdleConnections | int | `20` |  |
| global.legacyPostgres.postgresDatabases.platformHva.poolMaxOpenConnections | int | `20` |  |
| global.legacyPostgres.postgresDatabases.platformHva.port | int | `5432` |  |
...
| platformService.alerts.automation.backfillUsername.enabled | bool | `false` |  |
...
| platformService.alerts.automation.status.monitorAlertsEnabled | bool | `true` |  |
...
| platformService.hva.devmode | bool | `false` |  |
| platformService.hva.enabled | bool | `false` |  |
| platformService.hva.ingressEnabled | bool | `false` |  |
| platformService.hva.loggingLevel | string | `"info"` |  |
| platformService.hva.monitor.authCache.expiration | string | `"5m"` |  |
| platformService.hva.monitor.skipTLS | bool | `false` |  |
| platformService.hva.monitor.url | string | `"http://sysdigcloud-api:8080"` |  |
| platformService.hva.nats.js.clientName | string | `"sysdigcloud-platform-hva-service"` |  |
| platformService.hva.nats.js.enabled | bool | `true` |  |
| platformService.hva.nats.js.hva.stream.maxAge | string | `"0"` |  |
| platformService.hva.nats.js.hva.stream.maxBytes | string | `"2147483648"` |  |
| platformService.hva.nats.js.hva.stream.numReplicas | int | `3` |  |
| platformService.hva.nats.js.migrationFile | string | `"/platform-service/hva/nats/migrations/streams.json"` |  |
| platformService.hva.nats.js.tls.cert | string | `"/opt/certs/nats-js-tls-certs/ca.crt"` |  |
| platformService.hva.nats.js.tls.enabled | bool | `true` |  |
| platformService.hva.nats.js.url | string | `"nats"` |  |
| platformService.hva.readOnly | bool | `false` |  |
| platformService.hva.server.port.grpc | int | `8093` |  |
| platformService.hva.server.port.rest | int | `8092` |  |
| platformService.hva.zoneImport.awsFields | string | `""` |  |
| platformService.hva.zoneImport.azureFields | string | `""` |  |
| platformService.hva.zoneImport.gcpFields | string | `""` |  |
| platformService.hva.zoneImport.gitFields | string | `""` |  |
| platformService.hva.zoneImport.hostFields | string | `""` |  |
| platformService.hva.zoneImport.ibmFields | string | `""` |  |
| platformService.hva.zoneImport.imageFields | string | `""` |  |
| platformService.hva.zoneImport.kubeFields | string | `""` |  |
| platformService.hva.zoneImport.ociFields | string | `""` |  |
| platformService.hva.zonesServiceUrl | string | `"sysdigcloud-platform-zones-service-grpc:8091"` |  |
...
| platformService.platformHva.ingress[0].hosts[0].paths[0].apiGatewayRouteName | string | `"sysdigcloud-platform-hva-api"` |  |
| platformService.platformHva.ingress[0].hosts[0].paths[0].apiGatewayStickySessions | bool | `true` |  |
| platformService.platformHva.ingress[0].hosts[0].paths[0].openshiftRouteName | string | `"sysdigcloud-platform-hva-api"` |  |
| platformService.platformHva.ingress[0].hosts[0].paths[0].path | string | `"/api/v1/hva"` |  |
| platformService.platformHva.ingress[0].hosts[0].paths[0].pathType | string | `"ImplementationSpecific"` |  |
| platformService.platformHva.ingress[0].hosts[0].paths[0].serviceName | string | `"sysdigcloud-platform-hva-service-rest"` |  |
| platformService.platformHva.ingress[0].hosts[0].paths[0].servicePort | int | `8092` |  |
| platformService.platformHva.ingress[0].labels."app.kubernetes.io/managed-by" | string | `"ingress-config"` |  |
| platformService.platformHva.ingress[0].labels."app.kubernetes.io/name" | string | `"ingress-config"` |  |
| platformService.platformHva.ingress[0].labels."app.kubernetes.io/part-of" | string | `"sysdigcloud"` |  |
| platformService.platformHva.ingress[0].labels.role | string | `"ingress-config"` |  |
| platformService.platformHva.ingress[0].labels.tier | string | `"infra"` |  |
| platformService.platformHva.ingress[0].name | string | `"sysdigcloud-platform-hva-ingress"` |  |
...
| platformService.resources.platformAlertsBackfillUsername.limits.cpu | string | `"500m"` |  |
| platformService.resources.platformAlertsBackfillUsername.limits.memory | string | `"150Mi"` |  |
| platformService.resources.platformAlertsBackfillUsername.requests.cpu | string | `"100m"` |  |
| platformService.resources.platformAlertsBackfillUsername.requests.memory | string | `"100Mi"` |  |
...
| platformService.startupProbe.failureThreshold | int | `30` |  |
...
| platformService.zones.nats.js.zoneEvents.stream.duplicateWindowNanos | string | `"120000000000"` |  |
| platformService.zones.nats.js.zoneEvents.stream.maxAge | string | `"604800000000000"` |  |
| platformService.zones.nats.js.zoneEvents.stream.maxBytes | string | `"2147483648"` |  |
| platformService.zones.nats.js.zoneEvents.stream.numReplicas | int | `3` |  |
...
![Version: 0.0.1-main.2026-06-02T10-11-47Z.14a3f49](https://img.shields.io/badge/Version-0.0.1--main.2026--06--02T10--11--47Z.14a3f49-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 4.3.3-260708203934-main-v234dbf8](https://img.shields.io/badge/Version-4.3.3--260708203934--main--v234dbf8-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| global.secure.rulesDeployer.skip.windowsContents | string | `"no"` |  |
| global.secure.rulesDeployer.validateRules | string | `"yes"` |  |
| policies.analytics.cronjobSchedule | string | `"0 5 * * *"` |  |
| policies.analytics.dryRun | bool | `false` |  |
| policies.analytics.enabled | bool | `true` |  |
...
| policies.previewRules.v2Enabled | bool | `true` |  |
...
| policies.resources.policiesAnalyticsCronJob.limits.cpu | string | `"500m"` |  |
| policies.resources.policiesAnalyticsCronJob.limits.memory | string | `"512Mi"` |  |
| policies.resources.policiesAnalyticsCronJob.requests.cpu | string | `"200m"` |  |
| policies.resources.policiesAnalyticsCronJob.requests.memory | string | `"256Mi"` |  |
...
![Version: 1.2.1-260630225810-main-ve06e6db](https://img.shields.io/badge/Version-1.2.1--260630225810--main--ve06e6db-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 1.20.1-main.2026-07-06T15-47-05Z.a7ce56d](https://img.shields.io/badge/Version-1.20.1--main.2026--07--06T15--47--05Z.a7ce56d-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| promchap.clickhouse.retryBufferSize | int | `1000` |  |
...
![Version: 3.3.1-main.2026-07-09T07-05-50Z.v9c88e71](https://img.shields.io/badge/Version-3.3.1--main.2026--07--09T07--05--50Z.v9c88e71-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| promqlator.querySemaphore.timeout | string | `"30s"` |  |
...
![Version: 5.3.0-260629081721-main-vdea7d8b](https://img.shields.io/badge/Version-5.3.0--260629081721--main--vdea7d8b-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 2.2.14](https://img.shields.io/badge/Version-2.2.14-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.16.5](https://img.shields.io/badge/AppVersion-1.16.5-informational?style=flat-square)
...
| global.legacyRedis.redisTls.exporter.version | string | `"v1.43.22-ubi"` | redisTls exporter docker image tag |
...
| global.legacyRedis.redisTls.nodeaffinityLabel | object | `""` | DEPRECATED: use global.nodeaffinityLabel instead. Expects `{key, value}`; kept for backwards compatibility. global.nodeaffinityLabel takes precedence when set. |
...
| global.legacyRedis.redisTls.probes | object | `{"redis":{"liveness":{"failureThreshold":5,"initialDelaySeconds":180},"readiness":{"failureThreshold":5,"initialDelaySeconds":50}},"sentinel":{"liveness":{"failureThreshold":20,"initialDelaySeconds":300},"readiness":{"failureThreshold":5,"initialDelaySeconds":50}}}` | redisTls probe configuration. Override initialDelaySeconds/failureThreshold for slow storage environments. |
...
| global.legacyRedis.redisTls.probes.sentinel.liveness.failureThreshold | int | `20` | Consecutive failures before container restart (20 x 10s = 200s steady-state kill window absorbs brief sentinel TILT bursts) |
| global.legacyRedis.redisTls.probes.sentinel.liveness.initialDelaySeconds | int | `300` | Seconds before first liveness probe fires (covers up to 220s sentinel discovery on bootstrap) |
...
| global.legacyRedis.redisTls.sentinel.version | string | `"0.1.6"` | redisTls sentinel docker image tag |
...
| global.legacyRedis.redisTls.version | string | `"0.1.8"` | redisTls docker image tag |
| global.namespace | string | `"sysdig"` | where to install redis |
| global.nodeaffinityLabel | object | `{}` | node affinity label for redis pods. Expects `{key, value}`; both must be non-empty to take effect. Falls back to legacyRedis.redisTls.nodeaffinityLabel when unset. |
...
![Version: 5.2.1-260708164843-main-vc5339e3](https://img.shields.io/badge/Version-5.2.1--260708164843--main--vc5339e3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| global.legacyPostgres.postgresDatabases.sysdig.db | string | `""` |  |
| global.legacyPostgres.postgresDatabases.sysdig.host | string | `"sysdigcloud-postgresql"` |  |
| global.legacyPostgres.postgresDatabases.sysdig.port | int | `5432` |  |
| global.legacyPostgres.postgresDatabases.sysdig.sslmode | string | `"require"` |  |
| global.legacyPostgres.postgresDatabases.sysdig.username | string | `""` |  |
| global.namespace | string | `"sysdig"` |  |
| global.platformAuditTrail.enabled | bool | `false` |  |
| global.platformAuditTrail.ingestionEndpoint | string | `"sysdigcloud-platform-audit-grpc:5055"` |  |
| global.platformAuditTrail.metadataHeaders | string | `""` |  |
...
| remoteStorage.cassandra.chunkSizeBytes | int | `1048576` |  |
| remoteStorage.cassandra.enabled | bool | `false` |  |
| remoteStorage.cassandra.requestTimeout | string | `"30s"` |  |
| remoteStorage.cassandra.singleUploadMaxBytes | int | `10485760` |  |
...
![Version: 0.1.0-260702135339-main-v7b58207](https://img.shields.io/badge/Version-0.1.0--260702135339--main--v7b58207-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 2.0.0-260622082604-main-vf455738](https://img.shields.io/badge/Version-2.0.0--260622082604--main--vf455738-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 2.0.0-260707132831-main-v6f9d1e6](https://img.shields.io/badge/Version-2.0.0--260707132831--main--v6f9d1e6-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| scanningv2AgentsConf.skaffold | object | `{}` |  |
...
![Version: 2.0.0-260707133218-main-vba33952](https://img.shields.io/badge/Version-2.0.0--260707133218--main--vba33952-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| scanningv2Collector.findingLifecycle.grpc.endpoint | string | `"sysdigcloud-scanningv2-findinglifecycle-grpc-headless:6000"` |  |
| scanningv2Collector.findingLifecycle.grpc.tlsSkip | string | `"true"` |  |
...
| scanningv2Collector.skaffold | object | `{}` |  |
...
![Version: 2.0.0-260609170316-main-v014af01](https://img.shields.io/badge/Version-2.0.0--260609170316--main--v014af01-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| scanningv2Credentialstore.startupProbe.failureThreshold | int | `30` |  |
| scanningv2Credentialstore.startupProbe.initialDelaySeconds | int | `30` |  |
| scanningv2Credentialstore.startupProbe.periodSeconds | int | `10` |  |
| scanningv2Credentialstore.startupProbe.successThreshold | int | `1` |  |
| scanningv2Credentialstore.startupProbe.timeoutSeconds | int | `5` |  |
...
![Version: 2.0.0-260625153642-main-v47930a9](https://img.shields.io/badge/Version-2.0.0--260625153642--main--v47930a9-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 2.0.1-260707164418-main-vd6227e2](https://img.shields.io/badge/Version-2.0.1--260707164418--main--vd6227e2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| scanningv2Pkgmeta.skaffold | object | `{}` |  |
...
![Version: 2.0.0-260707132516-main-v5b164d4](https://img.shields.io/badge/Version-2.0.0--260707132516--main--v5b164d4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| scanningv2Policies.skaffold | object | `{}` |  |
...
![Version: 2.1.1-260611094901-main-vbc26727](https://img.shields.io/badge/Version-2.1.1--260611094901--main--vbc26727-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 2.0.0-260701134238-main-v89f051e](https://img.shields.io/badge/Version-2.0.0--260701134238--main--v89f051e-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 2.0.0-260707133227-main-vde6a2f7](https://img.shields.io/badge/Version-2.0.0--260707133227--main--vde6a2f7-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| scanningv2Riskmanager.skaffold | object | `{}` |  |
...
![Version: 2.0.0-260709122144-main-va18fd52](https://img.shields.io/badge/Version-2.0.0--260709122144--main--va18fd52-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 2.0.0-260709084625-main-v99157a0](https://img.shields.io/badge/Version-2.0.0--260709084625--main--v99157a0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| scanningv2Sbom.skaffold | object | `{}` |  |
...
![Version: 2.0.0-260707155533-main-vf2a241f](https://img.shields.io/badge/Version-2.0.0--260707155533--main--vf2a241f-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| scanningv2Scanengine.clickhouse.connMaxLifetimeMinutes | int | `60` |  |
| scanningv2Scanengine.clickhouse.enabled | bool | `true` |  |
| scanningv2Scanengine.clickhouse.maxIdleConns | int | `5` |  |
| scanningv2Scanengine.clickhouse.maxOpenConns | int | `10` |  |
| scanningv2Scanengine.clickhouse.readTimeoutSeconds | int | `60` |  |
| scanningv2Scanengine.clickhouse.username | string | `"reader"` |  |
| scanningv2Scanengine.customerMetrics.enabled | bool | `false` |  |
| scanningv2Scanengine.findingLifecycle.grpc.endpoint | string | `"sysdigcloud-scanningv2-findinglifecycle-grpc-headless:6000"` |  |
| scanningv2Scanengine.findingLifecycle.grpc.tlsSkip | string | `"true"` |  |
...
| scanningv2Scanengine.skaffold | object | `{}` |  |
...
![Version: 2.0.0-260708073904-main-v188209c](https://img.shields.io/badge/Version-2.0.0--260708073904--main--v188209c-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| scanningv2Scanrequestor.storage.fetchWindowDuration | string | `""` |  |
...
![Version: 2.0.0-260630144517-main-v16dd666](https://img.shields.io/badge/Version-2.0.0--260630144517--main--v16dd666-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| scanningv2Scanresults.ingress[0].hosts[0].paths[5].apiGatewayRouteName | string | `"sysdigcloud-scanningv2-scanresults-v360"` |  |
| scanningv2Scanresults.ingress[0].hosts[0].paths[5].openshiftRouteName | string | `"sysdigcloud-scanningv2-scanresults-v360"` |  |
| scanningv2Scanresults.ingress[0].hosts[0].paths[5].path | string | `"/api/scanning/scanresults/360"` |  |
...
| scanningv2Scanresults.serviceDependencies.runtimeview.grpc.endpoint | string | `"sysdigcloud-scanningv2-runtimeview-grpc-headless:6000"` |  |
| scanningv2Scanresults.serviceDependencies.runtimeview.grpc.tlsSkip | string | `"true"` |  |
...
![Version: 2.0.1-260707170101-main-v6f9ea5d](https://img.shields.io/badge/Version-2.0.1--260707170101--main--v6f9ea5d-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| scanningv2Vulns.rolling.maxSurge | string | `"25%"` |  |
| scanningv2Vulns.rolling.maxUnavailable | string | `"25%"` |  |
...
| scanningv2Vulns.skaffold | object | `{}` |  |
...
![Version: 1.0.0-260603130345-main-v3b9f664](https://img.shields.io/badge/Version-1.0.0--260603130345--main--v3b9f664-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 1.23.731-260709120026-main-v2f2c5fcc](https://img.shields.io/badge/Version-1.23.731--260709120026--main--v2f2c5fcc-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| image.tag | string | `"1.23.731-260709120026-main-v2f2c5fcc"` |  |
...
![Version: 3.1.0-260710105648-main-v614483f](https://img.shields.io/badge/Version-3.1.0--260710105648--main--v614483f-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| secureGraphIngestion.aws.bulkDeletion.batchTimeout | string | `"10m"` |  |
| secureGraphIngestion.aws.bulkDeletion.flushInterval | string | `"3s"` |  |
| secureGraphIngestion.aws.bulkDeletion.messageBatchSize | string | `"1"` |  |
...
| secureGraphIngestion.cleaner.earlyExitDivisor | string | `"2"` |  |
...
| secureGraphIngestion.cleaner.parallelContainerV2Edge | bool | `false` |  |
...
| secureGraphIngestion.postureEngine.batchTimeout | string | `"10m"` |  |
| secureGraphIngestion.postureEngine.enable | bool | `true` |  |
| secureGraphIngestion.postureEngine.flushInterval | string | `"3s"` |  |
| secureGraphIngestion.postureEngine.messageBatchSize | int | `200` |  |
| secureGraphIngestion.postureScanCompletedStreamEnabled | bool | `false` |  |
| secureGraphIngestion.postureV2Enabled | bool | `false` |  |
| secureGraphIngestion.progressDeadlineSeconds | int | `1200` |  |
| secureGraphIngestion.realtime.aws.bulkDeletion.batchSize | string | `"10"` |  |
| secureGraphIngestion.realtime.aws.consumerName | string | `"realtime-aws-processor"` |  |
| secureGraphIngestion.realtime.aws.deletion.batchSize | string | `"100"` |  |
...
| secureGraphIngestion.realtime.ibm.bulkDeletion.batchSize | string | `"10"` |  |
| secureGraphIngestion.realtime.ibm.consumerName | string | `"realtime-ibm-processor"` |  |
| secureGraphIngestion.realtime.ibm.deletion.batchSize | string | `"100"` |  |
...
| secureGraphIngestion.resourceComposer.batchTimeout | string | `"10m"` |  |
| secureGraphIngestion.resourceComposer.enable | bool | `true` |  |
| secureGraphIngestion.resourceComposer.flushInterval | string | `"3s"` |  |
| secureGraphIngestion.resourceComposer.messageBatchSize | int | `200` |  |
...
| secureGraphIngestion.vm.enableV2ExpiredDeleteNodes | bool | `false` |  |
...
| secureGraphIngestion.vm.newModelEnabled | bool | `false` |  |
| secureGraphIngestion.vm.newModelOnly | bool | `false` |  |
...
| secureGraphIngestion.vm.v2DeleteNodesOlderThan | string | `"48h"` |  |
| secureGraphIngestion.vm.v2ExpiredDeleteNodesOlderThan | string | `"12h"` |  |
...
| secureGraphIngestion.vm.v3BatchFlush | string | `"1m"` |  |
| secureGraphIngestion.vm.v3BatchSize | string | `"10"` |  |
| secureGraphIngestion.vm.v3ItemsBatchSize | string | `"2000000"` |  |
| secureGraphIngestion.vm.v3ParallelStep | bool | `false` |  |
| secureGraphIngestion.vm.v3ProcessingWorkers | string | `"2"` |  |
...
![Version: 3.0.0-260706140614-main-v74f96ea](https://img.shields.io/badge/Version-3.0.0--260706140614--main--v74f96ea-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 1.23.731-260630083636-main-vf82f405f](https://img.shields.io/badge/Version-1.23.731--260630083636--main--vf82f405f-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| dbImage.tag | string | `"1.23.731-260630083636-main-vf82f405f"` |  |
| global.apps | string | `"secure"` |  |
| global.iac.enabled | bool | `true` |  |
| global.iac.natsjs.endpoint | string | `"nats"` |  |
| global.iac.natsjs.insecure.enabled | bool | `false` |  |
...
| image.tag | string | `"1.23.731-260630083636-main-vf82f405f"` |  |
...
| secureIacAgenthandler.kspmAnalyzerIndependentMode | bool | `true` |  |
...
![Version: 1.23.731-260611145551-main-vcbb70a27](https://img.shields.io/badge/Version-1.23.731--260611145551--main--vcbb70a27-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| dbImage.tag | string | `"1.23.731-260611145551-main-vcbb70a27"` |  |
| global.api.serviceTokens.secureIac.serviceToken | string | `""` |  |
| global.apps | string | `"secure"` |  |
| global.iac.audit.workers | int | `5` |  |
| global.iac.enabled | bool | `true` |  |
...
| image.tag | string | `"1.23.731-260611145551-main-vcbb70a27"` |  |
| secureIacClusterAnalysis.audit.enabled | bool | `true` |  |
| secureIacClusterAnalysis.audit.useLegacyIngestion | bool | `false` |  |
...
![Version: 1.23.731-260708134750-main-v9df2d122](https://img.shields.io/badge/Version-1.23.731--260708134750--main--v9df2d122-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| dbImage.tag | string | `"1.23.731-260708134750-main-v9df2d122"` |  |
| global.apps | string | `"secure"` |  |
| global.complianceReview.allowedTenants | string | `"709521"` |  |
| global.complianceReview.newComplianceWorkflowChunkPolicies | int | `10` |  |
| global.complianceReview.taskTrackingRetentionHours | int | `1` |  |
...
| image.tag | string | `"1.23.731-260708134750-main-v9df2d122"` |  |
| secureIacCompliance.audit.enabled | bool | `true` |  |
| secureIacCompliance.audit.useLegacyIngestion | bool | `false` |  |
...
| secureIacCompliance.graphQueryMaxGlobalIdsPerZonesRequest | int | `500` |  |
...
| secureIacCompliance.newArchitectureEnabledForAll | bool | `false` |  |
| secureIacCompliance.newArchitectureEnabledTenants | string | `""` |  |
...
| secureIacCompliance.serveFromCache | bool | `false` |  |
...
| dbImage.tag | string | `"1.23.731-260709120026-main-v2f2c5fcc"` |  |
| global.apps | string | `"secure"` |  |
| global.iac.audit.workers | int | `5` |  |
| global.iac.clusterEnvironment | string | `"aws"` |  |
...
| image.tag | string | `"1.23.731-260709120026-main-v2f2c5fcc"` |  |
| secureIacPolicy.activeCustomersCacheTTL | string | `"5m"` |  |
| secureIacPolicy.audit.enabled | bool | `true` |  |
| secureIacPolicy.audit.useLegacyIngestion | bool | `false` |  |
...
![Version: 1.23.731-260709160324-main-v908620a7](https://img.shields.io/badge/Version-1.23.731--260709160324--main--v908620a7-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| dbImage.tag | string | `"1.23.731-260709160324-main-v908620a7"` |  |
| global.apps | string | `"secure"` |  |
| global.iac.apps | string | `"secure"` |  |
| global.iac.audit.workers | int | `5` |  |
| global.iac.cloudauth.endpoint | string | `"sysdigcloud-cloudauth-api-grpc:6000"` |  |
...
| image.tag | string | `"1.23.731-260709160324-main-v908620a7"` |  |
| secureIacScheduler.audit.enabled | bool | `true` |  |
| secureIacScheduler.audit.useLegacyIngestion | bool | `false` |  |
| secureIacScheduler.autoscale.enabled | bool | `true` |  |
| secureIacScheduler.autoscale.maxReplicaCount | int | `5` |  |
| secureIacScheduler.autoscale.minReplicaCount | int | `3` |  |
| secureIacScheduler.cloudScanDirectPublishEnabled | bool | `false` |  |
| secureIacScheduler.cloudScanDirectTenantIds | string | `""` |  |
...
| secureIacScheduler.internalDeleteGraphPruneEnabled | bool | `false` |  |
...
| secureIacScheduler.replicaCount | int | `3` |  |
...
| secureIacScheduler.workloadScanDirectEnabled | bool | `false` |  |
| secureIacScheduler.workloadScanDirectTenantIds | string | `""` |  |
...
![Version: 1.23.731-260624101258-main-v06fb7e82](https://img.shields.io/badge/Version-1.23.731--260624101258--main--v06fb7e82-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| dbImage.tag | string | `"1.23.731-260624101258-main-v06fb7e82"` |  |
| global.apps | string | `"secure"` |  |
| global.iac.audit.workers | int | `5` |  |
| global.iac.graphdb.enabled | bool | `true` |  |
| global.iac.ingestion.endpoint | string | `"sysdigcloud-events-ingestion:3000"` |  |
...
| image.tag | string | `"1.23.731-260624101258-main-v06fb7e82"` |  |
...
| secureIacWorkload.audit.useLegacyIngestion | bool | `false` |  |
...
![Version: 0.1.0-260622151448-main-vdb924a9](https://img.shields.io/badge/Version-0.1.0--260622151448--main--vdb924a9-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| secureInventory.sysql.cacheTTL | string | `"15m"` |  |
...
![Version: 0.1.0-260624154546-main-vc5a10d7](https://img.shields.io/badge/Version-0.1.0--260624154546--main--vc5a10d7-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 3.0.0-260709150023-main-v04587cf](https://img.shields.io/badge/Version-3.0.0--260709150023--main--v04587cf-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 2.0.0-260628182449-main-v6603691](https://img.shields.io/badge/Version-2.0.0--260628182449--main--v6603691-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| global.infraRepositoryPrefix | string | `"infra"` |  |
| global.ingressNetworking | string | `"hostnetwork"` |  |
| global.legacyPostgres.postgresDatabases.riskapi.admindb | string | `"postgres"` |  |
| global.legacyPostgres.postgresDatabases.riskapi.adminpassword | string | `"password"` |  |
| global.legacyPostgres.postgresDatabases.riskapi.adminusername | string | `"postgres"` |  |
| global.legacyPostgres.postgresDatabases.riskapi.db | string | `"risk"` |  |
| global.legacyPostgres.postgresDatabases.riskapi.host | string | `"sysdigcloud-postgresql"` |  |
| global.legacyPostgres.postgresDatabases.riskapi.password | string | `"test1234"` |  |
| global.legacyPostgres.postgresDatabases.riskapi.port | int | `5432` |  |
| global.legacyPostgres.postgresDatabases.riskapi.sslmode | string | `"disable"` |  |
| global.legacyPostgres.postgresDatabases.riskapi.username | string | `"riskuser"` |  |
| global.monitor.endpoint | string | `"http://localhost"` |  |
...
| global.namespace | string | `"sysdig"` |  |
| global.neo4jDatabases.risk.adminusername | string | `"neo4j"` |  |
| global.neo4jDatabases.risk.endpoint | string | `"bolt://host.docker.internal:7687"` |  |
| global.neo4jDatabases.risk.loglevel | string | `"INFO"` |  |
| global.neo4jDatabases.risk.password | string | `"test1234"` |  |
| global.neo4jDatabases.risk.username | string | `"neo4j"` |  |
| global.scaler.clusterName | string | `""` |  |
| global.secure.sysqlApi.enabled | bool | `true` |  |
| global.secure.sysqlApi.serviceToken | string | `nil` | sysqlApi token mounted from sysql-api chart secret |
| global.useHelm | bool | `true` |  |
| secureRiskApi.alerts.customerincludelist | list | `[]` |  |
| secureRiskApi.alerts.enableincludelist | bool | `false` |  |
| secureRiskApi.analytics.tracking.enabled | bool | `true` |  |
| secureRiskApi.attackPath.deleteBlobsTimeout | string | `"15m"` |  |
| secureRiskApi.audit.enabled | bool | `false` |  |
| secureRiskApi.consumers[0].command | string | `"policies"` |  |
| secureRiskApi.consumers[0].enabled | bool | `true` |  |
| secureRiskApi.consumers[0].maxRoutines | int | `12` |  |
| secureRiskApi.consumers[0].name | string | `"secure-risk-api-consumer-policies-evaluate-v1"` |  |
| secureRiskApi.consumers[0].nats.ackWait | string | `"60s"` |  |
| secureRiskApi.consumers[0].nats.durable | string | `"risks-policies"` |  |
| secureRiskApi.consumers[0].nats.keepAliveMessage | bool | `true` |  |
| secureRiskApi.consumers[0].nats.keepAliveMessageFrequency | string | `"20s"` |  |
| secureRiskApi.consumers[0].nats.messageType | string | `"risks-policies.evaluate.v1"` |  |
| secureRiskApi.consumers[0].nats.name | string | `"risks-policies"` |  |
| secureRiskApi.consumers[0].nats.queue | string | `"risks-policies"` |  |
| secureRiskApi.consumers[0].nats.streamname | string | `"risks-policies"` |  |
| secureRiskApi.consumers[0].nats.subject | string | `"risks-policies.evaluate.v1"` |  |
| secureRiskApi.consumers[0].replicas | int | `2` |  |
| secureRiskApi.consumers[0].resources.limits.cpu | int | `4` |  |
| secureRiskApi.consumers[0].resources.limits.memory | string | `"20Gi"` |  |
| secureRiskApi.consumers[0].resources.requests.cpu | string | `"250m"` |  |
| secureRiskApi.consumers[0].resources.requests.memory | string | `"500Mi"` |  |
| secureRiskApi.consumers[0].shortName | string | `"riskPoliciesEvaluateV1"` |  |
| secureRiskApi.consumers[1].command | string | `"userevent"` |  |
| secureRiskApi.consumers[1].enabled | bool | `false` |  |
| secureRiskApi.consumers[1].name | string | `"secure-risk-api-consumer-user-event-v1"` |  |
| secureRiskApi.consumers[1].nats.ackWait | string | `"60s"` |  |
| secureRiskApi.consumers[1].nats.durable | string | `"risks-user"` |  |
| secureRiskApi.consumers[1].nats.name | string | `"risks-user"` |  |
| secureRiskApi.consumers[1].nats.queue | string | `"risks-user"` |  |
| secureRiskApi.consumers[1].nats.streamname | string | `"risks"` |  |
| secureRiskApi.consumers[1].nats.subject | string | `"risks.user.compromised.state.notification"` |  |
| secureRiskApi.consumers[1].replicas | int | `2` |  |
| secureRiskApi.consumers[1].resources.limits.cpu | int | `2` |  |
| secureRiskApi.consumers[1].resources.limits.memory | string | `"4Gi"` |  |
| secureRiskApi.consumers[1].resources.requests.cpu | string | `"250m"` |  |
| secureRiskApi.consumers[1].resources.requests.memory | string | `"250Mi"` |  |
| secureRiskApi.consumers[1].shortName | string | `"riskUserEventV1"` |  |
| secureRiskApi.consumers[2].command | string | `"runtimeevent"` |  |
| secureRiskApi.consumers[2].enabled | bool | `false` |  |
| secureRiskApi.consumers[2].name | string | `"secure-risk-api-consumer-runtime-event-v1"` |  |
| secureRiskApi.consumers[2].nats.ackWait | string | `"60s"` |  |
| secureRiskApi.consumers[2].nats.durable | string | `"risks-events"` |  |
| secureRiskApi.consumers[2].nats.name | string | `"risks-events"` |  |
| secureRiskApi.consumers[2].nats.queue | string | `"risks-events"` |  |
| secureRiskApi.consumers[2].nats.streamname | string | `"events"` |  |
| secureRiskApi.consumers[2].nats.subject | string | `"events.source.events.policy.>"` |  |
| secureRiskApi.consumers[2].replicas | int | `2` |  |
| secureRiskApi.consumers[2].resources.limits.cpu | int | `2` |  |
| secureRiskApi.consumers[2].resources.limits.memory | string | `"4Gi"` |  |
| secureRiskApi.consumers[2].resources.requests.cpu | string | `"250m"` |  |
| secureRiskApi.consumers[2].resources.requests.memory | string | `"250Mi"` |  |
| secureRiskApi.consumers[2].shortName | string | `"riskRuntimeEventV1"` |  |
| secureRiskApi.consumers[3].command | string | `"exceptions"` |  |
| secureRiskApi.consumers[3].enabled | bool | `true` |  |
| secureRiskApi.consumers[3].name | string | `"secure-risk-api-consumer-exceptions-risk"` |  |
| secureRiskApi.consumers[3].nats.ackWait | string | `"60s"` |  |
| secureRiskApi.consumers[3].nats.durable | string | `"secure-vm-riskmanager-events"` |  |
| secureRiskApi.consumers[3].nats.messageType | string | `"secure.exceptions.events.v1"` |  |
| secureRiskApi.consumers[3].nats.name | string | `"secure-vm-riskmanager-events"` |  |
| secureRiskApi.consumers[3].nats.queue | string | `"secure-vm-riskmanager-events"` |  |
| secureRiskApi.consumers[3].nats.streamname | string | `"secure-vm-riskmanager-events"` |  |
| secureRiskApi.consumers[3].nats.subject | string | `"secure.exceptions.events.>"` |  |
| secureRiskApi.consumers[3].replicas | int | `1` |  |
| secureRiskApi.consumers[3].resources.limits.cpu | int | `2` |  |
| secureRiskApi.consumers[3].resources.limits.memory | string | `"4Gi"` |  |
| secureRiskApi.consumers[3].resources.requests.cpu | string | `"250m"` |  |
| secureRiskApi.consumers[3].resources.requests.memory | string | `"250Mi"` |  |
| secureRiskApi.consumers[3].shortName | string | `"riskExceptions"` |  |
| secureRiskApi.consumers[4].command | string | `"vm-exceptions"` |  |
| secureRiskApi.consumers[4].enabled | bool | `false` |  |
| secureRiskApi.consumers[4].name | string | `"secure-risk-api-consumer-vm-exceptions-risks"` |  |
| secureRiskApi.consumers[4].nats.ackWait | string | `"60s"` |  |
| secureRiskApi.consumers[4].nats.durable | string | `"secure-risk-vm-accepted-risks"` |  |
| secureRiskApi.consumers[4].nats.messageType | string | `"secure.vm.riskmanager.events.risk.update.v1"` |  |
| secureRiskApi.consumers[4].nats.nakDeliverBackOff | string | `"1m,2m,4m,8m"` |  |
| secureRiskApi.consumers[4].nats.name | string | `"secure-risk-vm-accepted-risks"` |  |
| secureRiskApi.consumers[4].nats.queue | string | `"secure-risk-vm-accepted-risks"` |  |
| secureRiskApi.consumers[4].nats.streamname | string | `"secure-vm-riskmanager-events"` |  |
| secureRiskApi.consumers[4].nats.subject | string | `"secure.vm.riskmanager.events.risk.update"` |  |
| secureRiskApi.consumers[4].shortName | string | `"vmExceptions"` |  |
| secureRiskApi.consumers[5].command | string | `"automations"` |  |
| secureRiskApi.consumers[5].enabled | bool | `true` |  |
| secureRiskApi.consumers[5].name | string | `"secure-risk-api-consumer-automations"` |  |
| secureRiskApi.consumers[5].nats.ackWait | string | `"60s"` |  |
| secureRiskApi.consumers[5].nats.durable | string | `"risks-automations"` |  |
| secureRiskApi.consumers[5].nats.name | string | `"risks-automations"` |  |
| secureRiskApi.consumers[5].nats.queue | string | `"risks-automations"` |  |
| secureRiskApi.consumers[5].nats.streamname | string | `"risks-automations"` |  |
| secureRiskApi.consumers[5].nats.subject | string | `"risks-automations.>"` |  |
| secureRiskApi.consumers[5].replicas | int | `2` |  |
| secureRiskApi.consumers[5].resources.limits.cpu | int | `2` |  |
| secureRiskApi.consumers[5].resources.limits.memory | string | `"4Gi"` |  |
| secureRiskApi.consumers[5].resources.requests.cpu | string | `"250m"` |  |
| secureRiskApi.consumers[5].resources.requests.memory | string | `"250Mi"` |  |
| secureRiskApi.consumers[5].shortName | string | `"riskAutomations"` |  |
| secureRiskApi.consumers[6].command | string | `"jiraticketcreated"` |  |
| secureRiskApi.consumers[6].enabled | bool | `true` |  |
| secureRiskApi.consumers[6].name | string | `"secure-risk-api-consumer-jira-ticket-created-v1"` |  |
| secureRiskApi.consumers[6].nats.ackWait | string | `"60s"` |  |
| secureRiskApi.consumers[6].nats.durable | string | `"risks-jiraticketcreated"` |  |
| secureRiskApi.consumers[6].nats.name | string | `"risks-jiraticketcreated"` |  |
| secureRiskApi.consumers[6].nats.queue | string | `"jira_issues"` |  |
| secureRiskApi.consumers[6].nats.streamname | string | `"jira_issues"` |  |
| secureRiskApi.consumers[6].nats.subjects | string | `"jira_issues.created,jira_issues.updated"` |  |
| secureRiskApi.consumers[6].replicas | int | `2` |  |
| secureRiskApi.consumers[6].resources.limits.cpu | int | `2` |  |
| secureRiskApi.consumers[6].resources.limits.memory | string | `"4Gi"` |  |
| secureRiskApi.consumers[6].resources.requests.cpu | string | `"250m"` |  |
| secureRiskApi.consumers[6].resources.requests.memory | string | `"250Mi"` |  |
| secureRiskApi.consumers[6].shortName | string | `"jiraTicketCreatedV1"` |  |
| secureRiskApi.consumers[7].command | string | `"jiraticketcreationfailed"` |  |
| secureRiskApi.consumers[7].enabled | bool | `true` |  |
| secureRiskApi.consumers[7].name | string | `"secure-risk-api-consumer-jira-ticket-creation-failed-v1"` |  |
| secureRiskApi.consumers[7].nats.ackWait | string | `"60s"` |  |
| secureRiskApi.consumers[7].nats.durable | string | `"risks-jiraticketcreationfailed"` |  |
| secureRiskApi.consumers[7].nats.messageType | string | `"jira_issues.creation_failed.v1"` |  |
| secureRiskApi.consumers[7].nats.name | string | `"risks-jiraticketcreationfailed"` |  |
| secureRiskApi.consumers[7].nats.queue | string | `"jira_issues"` |  |
| secureRiskApi.consumers[7].nats.streamname | string | `"jira_issues"` |  |
| secureRiskApi.consumers[7].nats.subject | string | `"jira_issues.creation_failed"` |  |
| secureRiskApi.consumers[7].replicas | int | `2` |  |
| secureRiskApi.consumers[7].resources.limits.cpu | int | `2` |  |
| secureRiskApi.consumers[7].resources.limits.memory | string | `"4Gi"` |  |
| secureRiskApi.consumers[7].resources.requests.cpu | string | `"250m"` |  |
| secureRiskApi.consumers[7].resources.requests.memory | string | `"250Mi"` |  |
| secureRiskApi.consumers[7].shortName | string | `"jiraTicketCreationFailedV1"` |  |
| secureRiskApi.enabled | bool | `true` |  |
| secureRiskApi.environment | string | `"DEVELOPMENT"` |  |
| secureRiskApi.evaluate.apiEvaluationEnabled | bool | `true` |  |
| secureRiskApi.evaluate.cron.activeDeadlineSeconds | int | `3600` |  |
| secureRiskApi.evaluate.cron.enabled | bool | `true` |  |
| secureRiskApi.evaluate.cron.schedule | string | `"0 * * * *"` |  |
| secureRiskApi.evaluate.enrichmentBatchSize | int | `100` |  |
| secureRiskApi.evaluate.maxParallelSubGraphWorkers | int | `10` |  |
| secureRiskApi.evaluate.parallelEvaluationCustomerIDs | string | `"all"` |  |
| secureRiskApi.evaluate.riskPolicyEvaluationTimeout | string | `"10m"` |  |
| secureRiskApi.evaluate.useAutomation | bool | `false` |  |
| secureRiskApi.evaluate.useStreamedEvaluation | bool | `true` |  |
| secureRiskApi.exception.api.address | string | `"sysdigcloud-scanningv2-riskmanager-api-grpc:6000"` |  |
| secureRiskApi.exception.api.cacheTTLSeconds | int | `600` |  |
| secureRiskApi.exception.api.receiveMessageSize | int | `8388608` |  |
| secureRiskApi.featureflags.isExceptionEnabled | bool | `false` |  |
| secureRiskApi.featureflags.upsertFindingsUsingHash | bool | `false` |  |
| secureRiskApi.featureflags.useNeo4jwithImpersonatedUser | bool | `true` |  |
| secureRiskApi.featureflags.useRealObjectStorage | bool | `false` |  |
| secureRiskApi.featureflags.useServiceTokenCustomerRepository | bool | `true` |  |
| secureRiskApi.featureflags.useSqlc | bool | `false` |  |
| secureRiskApi.image.pullSecret | string | `"sysdigcloud-pull-secret"` |  |
| secureRiskApi.ingressDev.enabled | bool | `false` |  |
| secureRiskApi.ingressDev.hosts | list | `[]` |  |
| secureRiskApi.ingressDev.tls | list | `[]` |  |
| secureRiskApi.ingress[0].hosts[0].paths[0].apiGatewayRouteName | string | `"secure-risk-api"` |  |
| secureRiskApi.ingress[0].hosts[0].paths[0].openshiftRouteName | string | `"secure-risk-api"` |  |
| secureRiskApi.ingress[0].hosts[0].paths[0].path | string | `"/api/risk/v1"` |  |
| secureRiskApi.ingress[0].hosts[0].paths[0].serviceName | string | `"secure-risk-api"` |  |
| secureRiskApi.ingress[0].hosts[0].paths[0].servicePort | int | `8080` |  |
| secureRiskApi.ingress[0].hosts[0].paths[1].apiGatewayRouteName | string | `"secure-risk-api-public-v1beta1"` |  |
| secureRiskApi.ingress[0].hosts[0].paths[1].openshiftRouteName | string | `"secure-risk-api-public-v1beta1"` |  |
| secureRiskApi.ingress[0].hosts[0].paths[1].path | string | `"/secure/risk/v1beta1"` |  |
| secureRiskApi.ingress[0].hosts[0].paths[1].serviceName | string | `"secure-risk-api"` |  |
| secureRiskApi.ingress[0].hosts[0].paths[1].servicePort | int | `8080` |  |
| secureRiskApi.ingress[0].labels."app.kubernetes.io/managed-by" | string | `"ingress-config"` |  |
| secureRiskApi.ingress[0].labels."app.kubernetes.io/name" | string | `"ingress-config"` |  |
| secureRiskApi.ingress[0].labels."app.kubernetes.io/part-of" | string | `"sysdigcloud"` |  |
| secureRiskApi.ingress[0].labels.role | string | `"ingress-config"` |  |
| secureRiskApi.ingress[0].labels.tier | string | `"infra"` |  |
| secureRiskApi.ingress[0].name | string | `"secure-risk-api-ingress"` |  |
| secureRiskApi.initDb.enabled | bool | `true` |  |
| secureRiskApi.initDb.image.pullSecret | string | `"sysdigcloud-pull-secret"` |  |
| secureRiskApi.internalMetricsGateway.timeout | string | `"5s"` |  |
| secureRiskApi.livenessProbe.enabled | bool | `true` |  |
| secureRiskApi.log.level | string | `"info"` |  |
| secureRiskApi.natsjs.consumer.live.ackWait | string | `"120s"` |  |
| secureRiskApi.natsjs.consumer.live.deliverpolicyall | bool | `true` |  |
| secureRiskApi.natsjs.consumer.live.durable | string | `"risks-live"` |  |
| secureRiskApi.natsjs.consumer.live.maxDeliver | int | `5` |  |
| secureRiskApi.natsjs.consumer.live.name | string | `"risks-live"` |  |
| secureRiskApi.natsjs.consumer.live.queue | string | `"risks-live"` |  |
| secureRiskApi.natsjs.consumer.live.streamName | string | `"risks"` |  |
| secureRiskApi.natsjs.consumer.live.subject | string | `"risks.live"` |  |
| secureRiskApi.natsjs.consumer.messagetype | string | `"risks.queryresult.v1"` |  |
| secureRiskApi.natsjs.consumer.scan.ackWait | string | `"120s"` |  |
| secureRiskApi.natsjs.consumer.scan.deliverpolicyall | bool | `true` |  |
| secureRiskApi.natsjs.consumer.scan.durable | string | `"risks-queryresult"` |  |
| secureRiskApi.natsjs.consumer.scan.maxDeliver | int | `5` |  |
| secureRiskApi.natsjs.consumer.scan.name | string | `"risks-scan-consumer"` |  |
| secureRiskApi.natsjs.consumer.scan.queue | string | `"risks-queryresult"` |  |
| secureRiskApi.natsjs.consumer.scan.streamName | string | `"risks"` |  |
| secureRiskApi.natsjs.consumer.scan.subject | string | `"risks.queryresult"` |  |
| secureRiskApi.natsjs.producer.riskalerts.messagetype | string | `"EVENT_TYPE_NEW_RISK"` |  |
| secureRiskApi.natsjs.producer.riskalerts.subject | string | `"risks-alerts.risk"` |  |
| secureRiskApi.natsjs.producer.riskobjectalerts.messagetype | string | `"EVENT_TYPE_NEW_RISK_RESOURCE"` |  |
| secureRiskApi.natsjs.producer.riskobjectalerts.subject | string | `"risks-alerts.riskobject"` |  |
| secureRiskApi.natsjs.stream.configFile | string | `"/config/streams/streams.json"` |  |
| secureRiskApi.natsjs.tls.enabled | bool | `true` |  |
| secureRiskApi.natsjs.url | string | `"nats"` |  |
| secureRiskApi.objectStorage.bucket | string | `""` |  |
| secureRiskApi.objectStorage.cassandra.blobsTTL | string | `"360h"` |  |
| secureRiskApi.objectStorage.cassandra.consistency | string | `"QUORUM"` |  |
| secureRiskApi.objectStorage.cassandra.protocolVersion | int | `3` |  |
| secureRiskApi.objectStorage.cassandra.reconnectInterval | string | `"5s"` |  |
| secureRiskApi.objectStorage.cassandra.reconnectRetries | int | `60` |  |
| secureRiskApi.objectStorage.cassandra.requestTimeout | string | `"30s"` |  |
| secureRiskApi.objectStorage.cassandra.tlsCaPath | string | `""` |  |
| secureRiskApi.objectStorage.cassandra.tlsCertPath | string | `""` |  |
| secureRiskApi.objectStorage.cassandra.tlsEnabled | bool | `false` |  |
| secureRiskApi.objectStorage.cassandra.tlsKeyPath | string | `""` |  |
| secureRiskApi.objectStorage.cassandra.tlsSkipVerify | bool | `false` |  |
| secureRiskApi.objectStorage.provider | string | `"s3"` |  |
| secureRiskApi.objectStorage.s3.accessKey | string | `""` |  |
| secureRiskApi.objectStorage.s3.endpoint | string | `""` |  |
| secureRiskApi.objectStorage.s3.region | string | `"us-east-1"` |  |
| secureRiskApi.objectStorage.s3.secretKey | string | `""` |  |
| secureRiskApi.objectStorage.s3.usePathStyle | bool | `false` |  |
| secureRiskApi.platformalerts.api.address | string | `"sysdigcloud-platform-alerts-api-grpc:5052"` |  |
| secureRiskApi.postgres.readyMaxRetries | int | `30` |  |
| secureRiskApi.postgres.readyPingTimeout | string | `"2s"` |  |
| secureRiskApi.postgres.readyRetryDelay | string | `"2s"` |  |
| secureRiskApi.producers[0].messageType | string | `"risks-policies.evaluate.v1"` |  |
| secureRiskApi.producers[0].name | string | `"risks-policies-evaluate-v1"` |  |
| secureRiskApi.producers[0].shortName | string | `"riskPoliciesEvaluateV1"` |  |
| secureRiskApi.producers[0].subject | string | `"risks-policies.evaluate.v1"` |  |
| secureRiskApi.producers[1].messageType | string | `"NOTIFICATION_TYPE_UNIFIED"` |  |
| secureRiskApi.producers[1].name | string | `"notifier"` |  |
| secureRiskApi.producers[1].shortName | string | `"notifier"` |  |
| secureRiskApi.producers[1].subject | string | `"notifier.notifications.1.risk"` |  |
| secureRiskApi.producers[2].name | string | `"jira-create-v1"` |  |
| secureRiskApi.producers[2].shortName | string | `"jiraCreateV1"` |  |
| secureRiskApi.producers[2].subject | string | `"risks-automations.create-ticket.v1"` |  |
| secureRiskApi.producers[3].name | string | `"alert-create-v1"` |  |
| secureRiskApi.producers[3].shortName | string | `"alertCreateV1"` |  |
| secureRiskApi.producers[3].subject | string | `"risks-automations.create-alert.v1"` |  |
| secureRiskApi.readinessProbe.enabled | bool | `true` |  |
| secureRiskApi.registryName | string | `"us-docker.pkg.dev/sysdig-artifact-registry-dev/gar-docker"` |  |
| secureRiskApi.replicaCount | int | `1` |  |
| secureRiskApi.repositoryPrefix | string | `"secure"` |  |
| secureRiskApi.resources.postgresqlinit.limits.cpu | int | `1` |  |
| secureRiskApi.resources.postgresqlinit.limits.memory | string | `"1Gi"` |  |
| secureRiskApi.resources.postgresqlinit.requests.cpu | string | `"125m"` |  |
| secureRiskApi.resources.postgresqlinit.requests.memory | string | `"125Mi"` |  |
| secureRiskApi.resources.riskEvaluateJob.limits.cpu | int | `1` |  |
| secureRiskApi.resources.riskEvaluateJob.limits.memory | string | `"1Gi"` |  |
| secureRiskApi.resources.riskEvaluateJob.requests.cpu | string | `"125m"` |  |
| secureRiskApi.resources.riskEvaluateJob.requests.memory | string | `"125Mi"` |  |
| secureRiskApi.resources.secureRiskApi.limits.cpu | int | `2` |  |
| secureRiskApi.resources.secureRiskApi.limits.memory | string | `"4Gi"` |  |
| secureRiskApi.resources.secureRiskApi.requests.cpu | string | `"250m"` |  |
| secureRiskApi.resources.secureRiskApi.requests.memory | string | `"250Mi"` |  |
| secureRiskApi.securityContext.allowPrivilegeEscalation | bool | `false` |  |
| secureRiskApi.securityContext.capabilities.drop[0] | string | `"ALL"` |  |
| secureRiskApi.securityContext.readOnlyRootFilesystem | bool | `true` |  |
| secureRiskApi.securityContext.runAsRoot | bool | `false` |  |
| secureRiskApi.securityContext.useSeccompProfile | bool | `true` |  |
| secureRiskApi.serviceAccount.annotations | object | `{}` |  |
| secureRiskApi.serviceAccount.create | bool | `true` |  |
| secureRiskApi.serviceAccount.name | string | `"secure-risk-api"` |  |
| secureRiskApi.serviceName | string | `"secure-risk-api"` |  |
| secureRiskApi.startupProbe.enabled | bool | `true` |  |
| secureRiskApi.startupProbe.failureThreshold | int | `3` |  |
| secureRiskApi.startupProbe.initialDelaySeconds | int | `5` |  |
| secureRiskApi.startupProbe.periodSeconds | int | `10` |  |
| secureRiskApi.startupProbe.successThreshold | int | `1` |  |
| secureRiskApi.startupProbe.timeoutSeconds | int | `5` |  |
| secureRiskApi.sysql.api.address | string | `"secure-sysql-api-headless:6000"` |  |
| secureRiskApi.sysql.api.receiveMessageSize | int | `67108864` |  |
| secureRiskApi.vmAcceptedRisks.postReadyWait | string | `"10m"` |  |
| secureRiskApi.workload.api.address | string | `"secure-iac-workload-service:8080"` |  |
...
![Version: 0.5.11-260709213311-main-ve09521e](https://img.shields.io/badge/Version-0.5.11--260709213311--main--ve09521e-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| sysqlApi.sysql.index_mapping.v2 | string | `"0.16.77"` |  |
| sysqlApi.sysql.index_mapping.v3-alpha | string | `"0.17.50"` |  |
| sysqlApi.sysql.index_mapping.v3-vmtest | string | `"0.15.0"` |  |
...
![Version: 5.1.1-260702110923-main-v1bdd8d8](https://img.shields.io/badge/Version-5.1.1--260702110923--main--v1bdd8d8-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| ticketing.jiraClientAllowPrivateTargets | bool | `false` |  |
...
| ticketing.startupProbe.failureThreshold | int | `60` |  |
| ticketing.startupProbe.initialDelaySeconds | int | `30` |  |
| ticketing.startupProbe.periodSeconds | int | `10` |  |
| ticketing.startupProbe.successThreshold | int | `1` |  |
| ticketing.startupProbe.timeoutSeconds | int | `5` |  |
...
![Version: 6.0.0-260709161129-main-v3deb90a](https://img.shields.io/badge/Version-6.0.0--260709161129--main--v3deb90a-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| uiAdmin.ingress[0].labels."app.kubernetes.io/managed-by" | string | `"Helm"` |  |
...
![Version: 6.0.0-260608221216-main-v2170866](https://img.shields.io/badge/Version-6.0.0--260608221216--main--v2170866-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 6.0.0-260710092647-main-vb64191a0](https://img.shields.io/badge/Version-6.0.0--260710092647--main--vb64191a0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
![Version: 6.0.0-260710104444-main-v0b9f0034](https://img.shields.io/badge/Version-6.0.0--260710104444--main--v0b9f0034-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| zookeeper.version | string | `"1.6.50"` | zookeeper image tag |
| zookeeper.zookeeperExporterVersion | string | `"v1.0.25-ubi"` | zookeeper exporter version |
