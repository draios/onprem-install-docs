...
-   See [Advanced Configurations](04-advanced_configuration.md#use-hostpath-for-static-storage-of-sysdig-components) for details.
...
2. Pull the image containing the self-extracting tar:
      ```bash
      docker pull quay.io/sysdig/installer:6.0.1-1-uber
      ```
3. Extract the tarball:
      ```bash
      docker create --name uber_image quay.io/sysdig/installer:6.0.1-1-uber
...
- See [Configuration Parameters](02-configuration_parameters.md) for all the configuration parameters available, as well as their definitions, values, and examples
